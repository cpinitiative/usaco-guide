...
Therefore, we are motivated to use Breadth-First-Search. A trasition edge has
...
the queue. This way, we will always check blocks that require less flips before
moving forward.
