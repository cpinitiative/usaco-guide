...
Since this problem can be reduced to a shortest path problem with edge lengths of 0 or 1, we can use BFS.
A transition edge has the weight 1 if the gravity is flipped or 0 if Captain Bovidian only moves left
