...
![Venn Diagram 1](http://www.usaco.org/current/data/fig2_evolution_bronze_open19.png)
...
![Venn Diagram 2](http://www.usaco.org/current/data/fig3_evolution_bronze_open19.png)

If you look at this picture carefully, hopefully you see a tree formed by the nesting structure of the sets:

![Evolution tree diagram](http://www.usaco.org/current/data/fig4_evolution_bronze_open19.png)
...
So, we actually don't need to build a proper evolutionary tree, but we just need to test if any of our characteristics represent crossing sets; if so (and only if so), a proper tree is impossible to build. This leads to the solution where we build all the sets of populations having each characteristic and then test if any pair of these sets is crossing.
