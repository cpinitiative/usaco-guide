...
3. Cow $1$ is neither fixed nor in the hierarchy: In this case, we would want to place every cow in the hierarchy as late as possible, allowing for cow one to get the earliest position possible.
