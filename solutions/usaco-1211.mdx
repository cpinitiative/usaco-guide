...
[Official Analysis](http://usaco.org/current/data/sol_prob3_gold_feb22.html)

## Solution

The subtask of this problem can be solved using brute force: insert all the edges from $N$ points into an edge list and solve using Kruskal's MST algorithm. Upon closer look at our brute force solution, the actual bottleneck is the time to insert all the edges.
...
// Following are two Union-Find data structure functions
