...
[Official Editorial](https://codeforces.com/blog/entry/61081)

## Solution

The official editorial mentions using [Heavy-Light Decomposition](/plat/hld) to solve this problem, but never discusses the solution.
