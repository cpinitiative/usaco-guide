...
Since $N \le 5000$ we can try iterate through every pair of points.
...
int main() {
	...
	/*
	 *	Instead of using a map - adding this way logN to the complexity - 
	 *  use a simple hashtable. The coordinates' small values allows us
	 *  to simply concatenate the abscissa and ordinate.
	 */
