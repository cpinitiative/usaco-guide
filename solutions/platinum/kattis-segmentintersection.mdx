...
The solution is the basic implementation of "Line Segment Intersection" mentioned [here](https://cp-algorithms.com/geometry/segments-intersection.html)
...
// BeginCodeSnip{Line Segment Intersection (from link)}
