...
The easiest way is to binary search its length. If you are not familiar with finding segment intersection, it may be worth solving [this](https://cses.fi/problemset/task/1740) first.
