...
Edge Case : This may NOT be true when the line segments are paralell. In that case, the shortest distance can be obtained from a set of infinite points which contains atlease one of the endpoints.
