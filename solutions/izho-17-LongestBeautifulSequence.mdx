...
And we want some number AND $\texttt{cur} = 8$.
...
te DP array that there's an element ($\texttt{pre}$), black part is $0011110101$
...
last element. When we get to $0011110101$, the black part has contribution 3,
