...
We count the number of pairs $(cow_1, cow_2)$ such that $cow_1$ enters before $cow_2$ and leaves sometime between $cow_2$'s entrance and exit (assuming without loss of generality that the 52-character string represents the entry and exit points of the cow in alphabetical way). 
