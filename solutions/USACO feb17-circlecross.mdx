...
We can also find the number of pairs $(cow_1, cow_2)$ such that the $cow_1$ enters before the $cow_2$ and leaves after $cow_2$ enters (assuming without loss of generality that the 52-character string represents the entry and exit points of the cow in alphabetical way). 
