...
That's right - we use Euler's formula to count the number of faces of a [planar graph](http://discrete.openmathbooks.org/more/mdm/sec_planar.html). This suggests that we should turn our rectangles into planar graphs.
