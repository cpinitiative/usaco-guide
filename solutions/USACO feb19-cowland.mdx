...
[this section](https://usaco.guide/gold/tree-euler).
...
tree. See
[the solution for Path Queries](https://usaco.guide/solutions/cses-1138) for a
comprehensive explanation.

Let the prefix XOR at $i$ be $X(i)$.

The difference between the explanation for Path Queries and this problem is that
we have range XOR queries instead of range sum queries.
