...
void floodfill(int x, int y) {
	...
	// Ignore this room if it isn't connected to main component (i.e. it's inaccessible to Bessie)
	...
	for (int i = 0; i < switches[x][y].size(); i++) {
		...
		// If this room hasn't been lit yet, add it to our count of rooms that have been lit
