...
Clarification:
The optimization the author uses is this property of fractions modulo $998244353$ is this:
...
// sauce: https://usaco.guide/gold/modular?lang=java
...
public class SantaBot {
    ...
    // copied from the cses exponentiation solution here: https://usaco.guide/gold/modular?lang=java
