...
public class RestaurantCustomers {
	...
	static class comparator implements Comparator<CustomerData> {
		public int compare (CustomerData one, CustomerData two) {
	...
	public static void main(String[] args) {
		...
		int n = io.nextInt();
		CustomerData[] data = new CustomerData[2 * n];
