...
To determine the number of ways to insert the blocks into the odd positions, we can evaluate ${\text{number of open spots} \choose \textbf{number of spots that we want to fill}}$.
