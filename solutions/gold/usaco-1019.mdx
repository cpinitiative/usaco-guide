...
Since the number of divisors for $N$ is around $\log N$, we will be iterating over all nodes only $\log N$ times. A table for an upper bound of the number of divisors can be found [here](https://wwwhomes.uni-bielefeld.de/achim/highly.txt).
