...
We can turn each of the $(n+1)(m+1)$ grids constructed by the $N$ vertical and $M$ horizontal fences into a node, and the edge weight between the four surrounding nodes their shared side length.
