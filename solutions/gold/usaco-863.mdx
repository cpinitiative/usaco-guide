...
Notice the constraints on the input, O(NK) is feasible.
...
This can be solved with dynamic programming. Keeping a DP array, where ith element represent the best possible sums from 1 to ith cow.
