...
Let the complexity sum of the first $k$ segments be $c_k$. Use $c_k$ to calculate $c_{k+1}$ in a process similar to dynamic programming, and our final answer would be $c_N$.
