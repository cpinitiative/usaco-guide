...
int main() {
    ...
    for (int t = 0; t < test_num; t++) {
        ...
        const auto get_best = [&](const auto &pf, int num) -> ll {
        ...
        for (int i = 1; i <= k_max; i++) {
             ...
             * In this case, because our function strictly increases, reaches its maximum,
             * and becomes strictly decreasing, we find the first point where the function
             * beceomes strictly decreasing.
             */
