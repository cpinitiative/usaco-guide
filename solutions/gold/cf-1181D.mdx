...
How do we answer individual years? We can use a BST to track the initial indicies of each city $1, 2, 3 \dots i$. Note that tie for occurrences is broken by initial indices, not the sorted.
