...
[Official Analysis](https://archive.org/download/oi-ted-ceoi-archive/CEOI/2018/)
...
**Time Complexity:** $\mathcal{O}(T \log T + T \cdot C)$ where $T$ is the total
number of transactions and $C$ is `max_computers`
