...
* The first option is to add the person as an audience member, provided that the audience is not yet full. In this case, the DP transition is: we either keep the current strength, or add this person to the audience to increase it:
