...
* *Cost Left:* The number of swaps needed to move $x$ to the left of $S$ is exactly the count of elements in $S$ that are currently at indices *less than* $x$'s index.
* *Cost Right:* The number of swaps needed to move $x$ to the right of $S$ is exactly the count of elements in $S$ that are currently at indices *greater than* $x$'s index.
