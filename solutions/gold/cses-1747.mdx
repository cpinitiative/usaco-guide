...
Now this essentially reduces to *dynamically* counting the number of inversions. We model the array as a binary sequence where a *1* represents an already processed (larger) element.
