...
* The largest element should be in the "peak" of pyramid. (This does NOT necessarily mean in the middle)
* If we think of the second largest element, it should be either in the left or right of largest
* Third largest should be in the left or right of these two
...
4.  After processing, we mark index $i$ as "active" (containing a processed element). This is the *Update*.
...
Since we need both operations to be efficient, a **Binary Indexed Tree (Fenwick Tree)**. 
