...
of disjoint cycles. To understand why, observe that a node connected to a cycle without being part of it would imply that some node has in-degree greater than one.
