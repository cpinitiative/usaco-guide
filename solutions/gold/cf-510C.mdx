...
What is the thing that the problem wants us to sort that we can apply topological sort on?
</Spoiler>

<Spoiler title="Hint 2">
In topological sort, we look at which nodes must be visited before each node. We can make the characters of the alphabet these nodes.
</Spoiler>
