...
<Info title="Runtime Note (updated Dec 2025)">

The USACO graders nowadays are about 2.5x faster than they were at the time of
this contest. Keep this in mind if your solution's runtime exceeds 0.8s.
...
[Minimum Spanning Tree (MST)](/gold/mst) of all $N$ cows. By adding the $i$-th edge to the
