...
[Stars and bars](https://artofproblemsolving.com/wiki/index.php/Ball-and-urn) tells us that the number of ways to seperate $n$ indistinguishable items into $k$ distinguishable groups is $n + k - 1 \choose k - 1$.
