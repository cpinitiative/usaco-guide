...
This problem is very similar to the "[Longest Flight Route](https://usaco.guide/gold/toposort?lang=py#solution---longest-flight-route)" problem discussed
...
backedge = [[] for _ in range(100001)]
...
while q:
	...
	for prev_node in backedge[node]:
		dp[node] = (dp[node] + dp[prev_node]) % 1000000007
