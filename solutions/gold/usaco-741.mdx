...
[Official Analysis (with hashing) (C++)](http://www.usaco.org/current/data/sol_cownomics_gold_open17.html)
...
**Time Complexity:** $\mathcal{O}(NM^2\log N)$ solution:
...
**Time Complexity:** $\mathcal{O}(NM^2)$ solution:
