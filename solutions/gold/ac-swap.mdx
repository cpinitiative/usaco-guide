...
Thus, $K \leq 29+28+27+\dots = \frac{29 \cdot 30}{2} = 435$.

</Spoiler>

<Spoiler title="Solution">

[Official Editorial (Python)](https://atcoder.jp/contests/abc227/editorial/2920)
...
const int LETTERS = 3;
const int MAX_SWAPS = 435;  // see hint above
