...
Maybe there exists a workaround that can allow us to establish less edges at beginning while ensuring all the edges that should belong to the MST are not filtered out?
