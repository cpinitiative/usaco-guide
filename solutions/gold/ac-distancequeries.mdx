...
The solution below uses [binary jumping](/plat/binary-jump) to find the LCA between two nodes. However, the approach described in this module will also suffice.
