...
title: Haybale Feast
author: Chongtian Ma, Ruben Jing
---
...
To find the lowest maximum haybale spiciness, we find the maximum spiciness of a sliding window
meeting the minimum flavor sum requirement. We use a sliding window because the haybales must be consecutive.

This is achieved by expanding our window to the right until the flavor sum requirement is met, then finding the largest
element in our window.

It is best to not expand our window after the flavor sum requirement is met because it potentially will result in adding
