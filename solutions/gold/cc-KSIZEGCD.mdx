...
Note that the GCD can only decrease and there are two ways for it to do so, it will either remove some factor from the current GCD or find another GCD at a different position.
