...
<Spoiler title="Hint">
Instead of trying to find the number of incompatible pairs, try to find the number of compatible pairs!

This is known as [complementary counting](https://artofproblemsolving.com/wiki/index.php/Complementary_counting) :D
</Spoiler>
...
We can use PIE (Principle of Inclusion/Exclusion) to calculate this! This means we'll have to add all pairs of cows that share one flavor in common, subtract cows that share two flavors,
and so on...
