...
public class StuckInARut {
	...
	// sorts eastward cows by their y value
	static class EastComparator implements Comparator<Integer> {
	...
	// sorts northward cows by their x value
	static class NorthComparator implements Comparator<Integer> {
		public int compare (Integer first, Integer second) {
	...
	public static void main(String[] args) throws IOException {
		...
		Collections.sort(eastCows, new eastComparator());
		// sort the north cows by x-coordinate
		Collections.sort(northCows, new northComparator());
