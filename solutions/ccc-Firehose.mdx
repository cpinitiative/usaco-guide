...
**Time Complexity**: $\mathcal O(h^2\times log(1000000))$
...
const int MAX_H = 1000, STREET_SIZE = 1000000;

int num_houses, num_hydrants, houses[MAX_H];
