...
To ensure the edges picked are optimal, we construct a minimum spanning tree, which can be solved by [Kruskal's MST algorithm](https://usaco.guide/gold/mst#kruskals).
