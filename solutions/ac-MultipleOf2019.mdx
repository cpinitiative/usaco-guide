...
For example, if our string was $$1234$$ and the modulus was $$3$$, the suffix array would be
...
However, note that **we do not need to know the specific indicies- we just need to know the amount of times a certain remainder occurs.** 
