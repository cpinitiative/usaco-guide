...
Thus, we can take $${N \choose K}$$, and choose 2 numbers that are divisible by the same remainder of 2019, where $$N=$$ the amount of times a certain remainder occurs, and $$K=$$ 2 (because we are picking 2 indicies $$i$$ and $$j$$). 

We can then store all the counts of all the remainders in an array from $$0...2018$$. Then, we can add $${N \choose 2}$$ and that is our answer. 
