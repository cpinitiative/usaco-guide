...
Thus, we can use take the binomial coefficient $${N \choose K}$$, and choose 2 numbers that are divisible by the same reminder of 2019, where $$N=$$ the amount of times a certain remainder occurs, and $$K=$$ 2 (because we are picking 2 indicies $$i$$ and $$j$$). 
