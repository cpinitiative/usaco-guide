...
This is a simple Centroid problem where we're asked to find the centroid. For more information about centroids, see [here](https://usaco.guide/plat/centroid).
