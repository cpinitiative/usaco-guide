...
def dfs(node: int, parent: int, col: bool) -> int:
	...
	# if using recursion in Python, sometimes you can increase recursion depth
	# with sys.setrecursionlimit(n), but this still causes stack overflow for this problem
