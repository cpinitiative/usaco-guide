...
Apply a rotation of 45 degrees on the grid like follows. Our goal is that, instead of a diamond as seen in the problem statement, the cells that Bessie can walk to forms a square.
<table>
<tr>
<td colspan="2">0</td>
<td colspan="2">0</td>
