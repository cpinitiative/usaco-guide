...
## Solution
<Spoiler title="Please read the walkthrough before opening this!">
...
To calculate the sum of the numbers in these square ranges, we just use 2D prefix sums normally.
</Spoiler>
