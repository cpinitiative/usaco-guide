...
If we simply rotate 45 degrees and cram all the diagonals into rows, it leads to an awkward situation like this one.
<table>
<tr>
<td colspan="2">0</td>
<td colspan="2">0</td>
...
<br></br>
This makes no sense as all as there are half-distances, how do you even put this into a 2D array? Therefore, we simply expand the grid by a factor of 2 to resolve this.
