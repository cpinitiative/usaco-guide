...
To calculate the sum of the numbers in these ranges, which are now the shapes of squares, we just use 2D prefix sums normally. Finally, we can brute force through all the squares Bessie can be and take the maximum sum.
