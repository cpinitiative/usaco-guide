...
## Explanation
Instead of keeping two prefix sums for the amount of cows above and below a y-coordinate, we can
simply keep one prefix sum: a 2D prefix sum directly summing the coordinate compressed grid.

The main difference between this and the solution above is that this solution uses rectangular 
sums to find the points above and below a y-coordinate, while the solution above keeps track 
