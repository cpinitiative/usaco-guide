...
## Explanation
The central idea behind this solution is identical to the previous solution, but differs
in how we count the cows above and below a bounding box.

Instead of keeping two prefix sums for the number of cows above and below a y-coordinate, we 
