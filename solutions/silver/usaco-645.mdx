...
we'd have a case where one enclosure has to contain some cow on the x-axis *and* some cows on the y-axis as the other enclosure.
...
Using binary search instead of prefix/suffix minimums and maximums is also possible.
