...
Try coding a normal BFS for this problem first. What specific problems do you notice?

</Spoiler>

<Spoiler title="Hint 2">

Say we flip on a switch. What other rooms could this affect? What would we have to do to make sure these changes are accounted for?
