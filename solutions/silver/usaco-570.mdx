...
Pretend the time restriction does not apply. What is the most straight-forward bruteforce solution you can think of that solves this problem?

</Spoiler>

<Spoiler title="Hint 2">

Do you notice what rooms that are not required to be rechecked in the previous iteration?
