...
public class MagazineAd {
    public static void main(String[] args) throws IOException {
        ...
        for (char i : ad.toCharArray()) {
            wordLengths.set(wordLengths.size() - 1, wordLengths.get(wordLengths.size() - 1) + 1);
    ...
    private static boolean widthValid(int width, List<Integer> wordLengths, int maxLines) {
        int lines = 0;
        int currWidth = 0;
