...
We can break the ad into blocks of word lengths, with each word length including the word (except for the last word) plus a space or a hyphen since spaces and hyphens function similarly.
