...
public class BuildGates {
    static final int MAX = 4003;
	static boolean[][] fence = new boolean[MAX][MAX];
    static boolean[][] visited = new boolean[MAX][MAX];
    static int MAX_X = 2001, MIN_X = 2001, MAX_Y = 2001, MIN_Y = 2001;
	public static void main(String[] args) throws IOException {
        ...
        int x = 2001, y = 2001; // x and y origin values
    ...
    public static void dfs(int startX, int startY) {
        ...
        while (!stack.isEmpty()) {
            ...
            for (int k = 0; k < 4; k++) {
                ...
                if (nx >= MIN_X && nx <= MAX_X && ny >= MIN_Y && ny <= MAX_Y && !visited[nx][ny] && !fence[nx][ny]) {
                    visited[nx][ny] = true;
