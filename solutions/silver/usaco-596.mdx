...
The Flood Fill approach as mentioned in C++ version didn't pass all test cases, so we switched it to BFS.
</Info>
...
public class BuildGates {
	static boolean[][] fence = new boolean[4003][4003];
    static boolean[][] visited = new boolean[4003][4003];
    static int maxx = 2001, minx = 2001, maxy = 2001, miny = 2001;
	public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < n; i++) {
            ...
            fence[x + dir.get(path.charAt(i))[0]][y + dir.get(path.charAt(i))[1]] = true;
            fence[x + 2 * dir.get(path.charAt(i))[0]][y + 2 * dir.get(path.charAt(i))[1]] = true;
	...
	public static void bfs(int startX, int startY) {
        ...
        while (!queue.isEmpty()) {
            ...
            for (int k = 0; k < 4; k++) {
                ...
                if (nx >= minx && nx <= maxx && ny >= miny && ny <= maxy && !visited[nx][ny] && !fence[nx][ny]) {
                    visited[nx][ny] = true;
