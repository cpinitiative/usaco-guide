...
We keep three prefix arrays: one for Holsteins, one for Guernseys,
and one for Jerseys. They will allow us to access how many
Holsteins/Guernseys/Jerseys exist on an interval.
