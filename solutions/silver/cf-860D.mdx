...
source: CF
title: Wizard's Tour
author: Benjamin Qi, David Guo
---

[Official Editorial](https://codeforces.com/blog/entry/54604)
...
1. The task can be solved independently for each component.
2. The answer is always $\left\lfloor \frac{m}{2}\right\rfloor$ for a single connected component.
