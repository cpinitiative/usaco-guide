...
Let $k$ equal the maximum number of berries in one basket,
what can we say about the capacity of the rest of the baskets?
</Spoiler>

<Spoiler title="Hint 1 (answer)">
You want to maximize the number of baskets with $k$ berries.
</Spoiler>
