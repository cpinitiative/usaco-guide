...
If there are still buckets to fill after this, sort the remaining trees by the value $B_i \bmod b$,
where $B_i$ is the number of berries on tree $i$.
hen, iterate through the trees in descending order of $B_i \bmod b$,
