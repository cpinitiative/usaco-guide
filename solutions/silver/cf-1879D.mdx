...
(r - l + 1)$ to the answer, where $p$ is the parity of this bit's occurrences. This is because if we perform xor on the same number an even number of times, the xor operations will evenly cancel out.
