...
Since the diameter is the longest path, either endpoint is guaranteed to be furthest away. Therefore, the point with the maximum distance is one of the endpoints of the diameter.
We can run DFS again from this point, where the maximum distance from this new point is our actual diameter.

This DFS Twice approach is [Approach 2](https://usaco.guide/CPH.pdf#page=145) in CPH 14.2.
