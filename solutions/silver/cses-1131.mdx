...
For a more detailed explanation, see Algorithm 2 in [CPH 14.2](/CPH.pdf#page=145).
...
For a more detailed explanation, see Algorithm 1 in [CPH 14.2](/CPH.pdf#page=145).
