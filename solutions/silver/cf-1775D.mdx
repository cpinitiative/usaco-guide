...
// This represents the maximum number of primes under the maximum a.
const int MAXPRIMES = 100000;
// MAXN is the maximum n for this problem.
const int MAXN = 300000;
const int MAXNODES = MAXN + MAXPRIMES;
// MAXNUM is the maximum possible a[i] from the problem constraints.
...
// Inputs a as the number, and i as the index.
