...
## Explanation
We can use binary search to find an apartment that is in the range of
...
Note that we have to sort the apartments so applicants could be 
matched with the apartment closed to their desired size.
