...
Therefore, we present here how one might arrive at this solution and be convinced that it works.
...
For the rigorous proof by Lewis Gan, you can check the [official editorial](https://codeforces.com/blog/entry/43493).
