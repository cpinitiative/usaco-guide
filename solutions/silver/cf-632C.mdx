...
Therefore, we first present how one might arrive at this solution and be convinced that it works.
...
We construct our concatenation from left to right.
...
Once again, though this is not a rigorous proof, it is how one may arrive at the solution and convince themselves that it works.
