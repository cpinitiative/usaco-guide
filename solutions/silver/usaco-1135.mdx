...
Some of the candidate values could be invalid. Thus, we take all possible tuples of candidate values and check if this solution of $(A, B, C)$ can create a valid array of $A, B, C, A+B, \dots, A+B+C$.
