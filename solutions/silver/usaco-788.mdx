...
When there are $N$ videos and $N - 1$ relationships between them, what data structure you think can best store and process those information?
</Spoiler>

<Spoiler title="Hint 2">
Let's imagine manually searching through a tree of videos for a singular query. What observations can we make about how the relevance value influences our decision-making process in selecting the relevant videos?
</Spoiler>
