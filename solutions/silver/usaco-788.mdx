...
Say we only look at one query, imagine we search through a tree of videos manually, notice how the relevance value influences our decision making process in selecting the relevant videos.
</Spoiler>
