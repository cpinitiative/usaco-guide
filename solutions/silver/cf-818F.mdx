...
author: Justin Ji, Ruben Jing
---

[Official Editorial](https://codeforces.com/blog/entry/52991)
...
for _ in range(t):
	...
	while lo < hi:
		mid = (lo + hi + 1) // 2
		num_bridges = (mid + 1) // 2
		cycle_nodes = nodes - num_bridges
		cycle_edges = cycle_nodes * (cycle_nodes - 1) // 2
