...
with open("triangles.in", "r") as fin, open("triangles.out", "w") as fout:
    input = fin.readline
    N = int(input())
    coordinates = []
    x_values = dict()
