...
title: Snow Boots
author: Qi Wang, Ryan Chou, Juheon Rhee
---
...
Due to the low bounds on $N$ and $B$, we can run a [DFS (Depth First Search)](/silver/graph-traversal) on every possible location and boot size Farmer John could be wearing.
...
public class snowboot {
	...
	public static void main(String[] args) throws IOException {
		...
		PrintWriter out = new PrintWriter(
		    new BufferedWriter(new FileWriter("snowboots.out")));
		out.println(A);
		out.close();
	}
