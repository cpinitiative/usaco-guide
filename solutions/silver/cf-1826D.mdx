...
Precompute a prefix array that stores the maximum value of $beauty[i] + i$ for sights to the left of each point, and a suffix array that stores the maximum value of $beauty[i] - i$ for sights to the right of each point.
