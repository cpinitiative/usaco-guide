...
public class IcyPerimeter {
	...
	static final int[][] directions = {
	    ...
	    {1, 0},
	    {0, -1},
	    {0, 1}};  // Movement directions (up, down, left, right)
		...
		while (!queue.isEmpty()) {
			...
			for (int[] dir : directions) {
				...
				if (newX >= 0 && newX < n && newY >= 0 && newY < n) {
					if (grid[newX][newY] ==
					    '#') {  // If the neighbor is part of the same blob
						queue.add(
						    new int[] {newX, newY});  // Add the neighbor to the queue
...
const vector<pair<int, int>> directions = {
    {-1, 0}, {1, 0}, {0, -1}, {0, 1}};  // Movement directions (up, down, left, right)
