...
Let $\text{f}[i][j][l]$ represent if it is possible to reach $i$ and $j$ pail amounts in $l$ operations.
Our base case is $\text{f}[0][0][0]$ as true, since there is no milk initially.
