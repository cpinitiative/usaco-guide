...
![possible connected component](/solutions/silver/usaco-920/connected_component.png)

However, for each of the $K$ connected components, the grass types can be inverted and still be a valid solution:

![inverted connected component](/solutions/silver/usaco-920/inverted_connected_component.png)
...
Note how the nodes force their adjacen	t ones to have a specific coloring, so if any two nodes don't satisfy this condition, it's impossible.
