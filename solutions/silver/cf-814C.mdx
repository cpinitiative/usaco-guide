...
author: Neo Wang, Qi Wang, Jesse Choe, Kevin Sheng, Rameez Parwez, David Guo
---
...
public class Garland {
	public static void main(String[] args) throws IOException {
		...
		// Reading all the queries here is faster for some reason
...
# Solution 2 - Two Pointers with Prefix Sums
