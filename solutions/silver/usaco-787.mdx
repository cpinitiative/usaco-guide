...
Remember, at any time Farmer John should either milk the highest-producing cow or rent the lowest-producing cow based on whichever one makes the most money.
</Spoiler>
<Spoiler title="Hint 2">
Farmer John should always sell milk to the store which offers the most money, and rent to the farmer which offers the most money.
</Spoiler>
<Spoiler title="Solution">
## Explanation

To decide whether or not to milk or rent a cow, we should always compare the highest-producing cow with the highest offering store, and the highest offering farmer.

To do this, we can make 3 lists of stores, farmers, and cows, and sort the stores and farmers by the prices offered, and sort the cows by their milk-production.

Then, when we go through the list, we either milk the highest-producing cow or rent the lowest producing cow, based on which one makes more money.
