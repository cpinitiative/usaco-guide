...
We can optimize yet again by implementing prefix arrays. All countributions from pairs limited by $d_{desirable}$ can be found quickly using the prefix array, and all countributions from pairs limited by $d_{cow}$ can be found by multiplying $d_{cow}$ by the number of pairs limited. 
