...
![](/solutions/silver/usaco-1470/firstscenarioexact.png)

We observe that the same is true if we set $l$ to $i - 1$ and $r$ to $j + 1$.

![](/solutions/silver/usaco-1470/firstscenarioexpanded.png)
...
![](/solutions/silver/usaco-1470/firstscenarioall.png)
...
![](/solutions/silver/usaco-1470/firstscenariooptimization.png)
