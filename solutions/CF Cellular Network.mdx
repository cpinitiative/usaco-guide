...
This solution can also be implemented with Binary Search, but it's better to implement it with a set. The code below is provided only if you want additonal practice for Binary Searching a Sorted Array.
