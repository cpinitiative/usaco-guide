...
title: APIO 2014 Palindrome
author: Andi Qu
---

## Solution

First, construct the [palindromic tree](http://adilet.org/blog/palindromic-tree/) from the string. There are $\mathcal{O}(N)$ distinct palindromes, so our tree will have $\mathcal{O}(N)$ nodes.
