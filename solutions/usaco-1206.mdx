...
all gifts in the SCC through a series of reassignments by definition of an SCC. It is also guaranteed to receive one 
...
an SCC, it cannot receive a more optimal reassignment.
