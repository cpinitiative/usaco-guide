...
all gifts in the strongly connected component through a series of reassignments and is guaranteed to have one or more preferred gifts (including itself) based 
