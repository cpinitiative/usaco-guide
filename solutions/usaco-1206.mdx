...
all gifts in the strongly connected component through a series of reassignments based on SCC definition. It is also guaranteed it will be able to receive one 
or more preferred gifts (including itself) since we are only adding these gifts as outgoing edges.
## Implementation
