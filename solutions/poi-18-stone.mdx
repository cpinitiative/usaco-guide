...
## Solution
This question can be solved through radial sweepline. Therefore, we sort our list of vectors by angle from the horizontal counterclockwise. This step comprises the bulk of the process, at $\mathcal{O}(n \log n)$.
