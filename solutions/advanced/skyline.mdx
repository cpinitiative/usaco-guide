...
In this code, a dp approach is used (instead of the formula for finding) since the question requires the value modulo `1000000`. Since this is not a prime number *Fermat's Little theorem* can **not** be used for finding inverse factorials.
