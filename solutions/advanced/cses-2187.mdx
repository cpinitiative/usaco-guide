...
The idea is to calculate all the possible ways to arrange remaining pairs of parenthesis and then subtract the count of invalid ways (which is by taking more opening brackets than closing ones).
