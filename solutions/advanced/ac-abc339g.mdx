...
## [Official Editorial](https://atcoder.jp/contests/abc339/editorial/9270)

This uses merge-sort tree.

**Time Complexity:** $\mathcal{O}(N\log N+Q\log^2N)$
...
**Time Complexity:** $\mathcal{O}((N+Q)\log M)$, where $M$ is the max value

**Memory Complexity:** $\mathcal{O}(N\log M)$
