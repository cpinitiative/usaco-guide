...
To solve the problem, for a certain root with subtrees, $s_1, s_2, \dots, s_k$, we can try to convert all these subtrees into a stack of some size.
...
![](/solutions/advanced/ac-GameOnTree/gameontree.png)
