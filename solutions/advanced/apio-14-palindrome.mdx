...
First, construct the
[palindromic tree](https://web.archive.org/web/20220130034214/https://adilet.org/blog/palindromic-tree/)
from the string. There are $\mathcal{O}(N)$ distinct palindromes, so our tree
will have $\mathcal{O}(N)$ nodes.
