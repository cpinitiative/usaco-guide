...
$$
valuesOnTheLeftSide = cnt[leftSide[u]] + cnt[leftSide[v]] - cnt[leftSide[LCA]] - cnt[leftSide[parentOfLCA]]
$$
...
int L[MAX_NODES + 1], R[MAX_NODES + 1], t[MAX_NODES + 1], trs[MAX + 1], up[MAX + 1][LOG + 1];
