...
The crucial observation here is that the answer the answer for $n$ nodes is the $n$th Catalan number.
...
Since the the root of the tree can be any of the $n$ values, we can get the following recurrence relation:
$$
