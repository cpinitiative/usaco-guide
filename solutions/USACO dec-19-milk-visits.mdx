...
components = [1, 1, 2, 1, 3] <br/> <br/>
Farms 1,2, and 4 are all Holsteins and make up component 1, farm 3 makes up component 2, and farm 5 makes up component 3. 

When it comes to seeing which farmers will be happy, we just have to evalulate 2 conditions: <br/>
1. Farm $A$ and $B$ are part of the same component. If $C$ is the same breed as $A$, then we should output.
