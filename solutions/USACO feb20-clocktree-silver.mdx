...
If there are more nodes, we can treat it similar to 2 nodes by partitioning all the nodes into 2 groups and making this problem a bipartite graph problem.
We can partition the nodes into two groups using DFS if 2 neighbor nodes belong to different groups.
