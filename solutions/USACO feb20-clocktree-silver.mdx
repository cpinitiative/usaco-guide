...
We can check the initial sum difference between the two groups (mod 12) to figure out the final clock numbers, where we define group0 and group1 as the two groups we get after putting all rooms into the bipartite partition.
