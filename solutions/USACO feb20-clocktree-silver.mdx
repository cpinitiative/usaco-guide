...
Every time Bessie visits a neighbor node, the sum of clocks of the group that Bessie visits increases by 1.
...
1. If group0 is same as group2 (mod 12), Bessie can start from any node
