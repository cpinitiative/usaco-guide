...
Rect cut(Rect a, Rect b) {
	...
	//It cuts rectangle A based on rectangle B. (A - white sheet, B - black sheet)
...
#Print NO if after cutting the rectangle, the area is 0
#Print YES if after cutting the rectangle, it produces a positive area
