...
The main idea for the solution is to find all possible lengths of routes in both universes so we can preprocess all possible sums of lengths to reach the end in each
of the universes. 


## Finding All Possible Lengths of Routes

We can use dynamic programming by proccessing each node topologically to find the lengths of all the routes to the current node we are considering. We can store
