...
Our task is to calculate the area of the first rectangle not obscured by the second one (which is the green area as I described). There are [6 cases](https://imgur.com/a/OIxiZLM) and [the corner case (literally)](https://imgur.com/a/8QiaQ2i) to consider.
