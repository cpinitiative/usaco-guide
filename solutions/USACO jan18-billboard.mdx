...
Our task is to calculate the area of the first rectangle not obscured by the second one (which is the green area as I described). There are [6 cases](https://github.com/tachithanhdanh/CompetitiveProgramming/tree/main/USACO/Editorials/gallery/USACO-jan18-billboard) and [a corner case (literally)](https://github.com/tachithanhdanh/CompetitiveProgramming/blob/main/USACO/Editorials/gallery/USACO-jan18-billboard/Corner_Case.png) to consider.
