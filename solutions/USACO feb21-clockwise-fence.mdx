...
To find the area of a triangle with a vertex at $(0, 0)$, a second vertex at $(x_1, y_1)$ and third vertex at $(x_2, y_2)$, we can use the formula $\frac{x_1y_2 - y_1x_2}{2}$. This value is positive if $\frac{x_1}{y_1}$ is greater than $\frac{x_2}{y_2}$, since the slope becomes smaller, making it clockwise. Likewise, a negative area means the direction is counterclockwise.
