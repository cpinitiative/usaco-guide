---
id: cf-472D
source: Codeforces Round #270 (472)
...
**Time Complexity:** $\mathcal{O}(N^2\ logN)$ with Kruskal's MST or $\mathcal{O}(N^2)$ with N^2 Prims.
...
```cpp
//https://codeforces.com/contest/472/submission/116947272
