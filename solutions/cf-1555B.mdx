...
* $w_{1}$ and $h_{1}$ the width and height of table 1 (equal to the difference in $x_{1}$ and
$x_{2}$ and $y_{1}$ and $y_{2}$ respectively)
...
Note: when placing table 2 on the left and right sides, make sure $w_{1} + w_{2} \leq W$,
