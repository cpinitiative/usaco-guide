...
With this observation, the solution is relatively simple. Check for this adjacency, and if it is, print "No." Then, surround the bad people with walls. Floodfill from the end point ($$N - 1,\space M - 1$$), and make sure that all the good people have been visited. You do not need to check if the bad people did not make it, as surrounding the bad people with walls is sufficient. 
