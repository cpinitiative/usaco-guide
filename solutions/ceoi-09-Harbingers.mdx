...
This problem can also be solved with a persistant [Li-Chao tree](https://cp-algorithms.com/geometry/convex_hull_trick.html#toc-tgt-1) (although the memory limit is rather tight). 
