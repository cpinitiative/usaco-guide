...
Although BBSTs use 4 times less memory than segment trees, a BBST of BBSTs is
not possible. However, a segment tree of BBSTs **is** possible!
...
$\mathcal O(N \log N)$ to $\mathcal O(N)$.
