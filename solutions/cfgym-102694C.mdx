...
1. $e \geq dist(st, end)$. In this case the result will be the sloth reaching the
   end.

2. $e < dist(st, end)$ and $e < dist(st, lca)$ in which the result will be the
   sloth reaching the $e$th parent of $st$.

3. $e < dist(st, end)$ and $e \geq dist(st, lca)$ in which the result will be the
...
public class SlothNaptime {
	public static final int MAXN = (int) 3e5;
