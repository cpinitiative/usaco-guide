...
# Best scenario: the three elements are already
# in order.
if c == a + 2:
	print(0)
# If there is a difference by 2,
# it can be solved in one move.
# 3 5 9 -> 5 7 9
elif b == a + 2 or c == b + 2:
	print(1)
# It can always be solved in two moves since
# you can always move a -> c - 2 and b -> c - 1
# If there is less than one space between the two 
# elements, it'll be taken care of in the if 
# statement above.
else:
	print(2)
...
# Since there are 3 arrows, the worst case is 3 moves.
print(max(b-a, c - b) - 1)
