...
"""
	...
	print(1)
"""
It can always be solved in two moves since you can move 
a -> c - 2 and b -> c - 1 If there is less than one 
integer between the two elements, it'll be taken care of 
