...
"""
	...
	print(1)
"""
It can always be solved in two moves since you can always 
move a -> c - 2 and b -> c - 1 If there is less than one 
space between the two elements, it'll be taken care of 
