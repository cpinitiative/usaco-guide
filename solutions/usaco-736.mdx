...
bool test_location(int j)
{
  ...
  // found_cow[0] refers to spotty cows, and found_cow[1] refers to non-spotty cows.
        // found_cow[0][0] = stores whether spotty cows has character A at position j
        // found_cow[0][1] = stores whether spotty cows has character C at position j
        // found_cow[0][2] = stores whether spotty cows has character G at position j
        // found_cow[0][3] = stores whether spotty cows has character T at position j
        // found_cow[1][0] = stores whether plain cows has character A at position j
        // found_cow[1][1] = stores whether plain cows has character C at position j
        // found_cow[1][2] = stores whether plain cows has character G at position j
        // found_cow[1][3] = stores whether plain cows has character T at position j
