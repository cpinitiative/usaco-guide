...
We may **not** use [`std::set`](http://www.cplusplus.com/reference/set/set/) because it does not support indexing. Additionally, since BBSTs do *not* support random access, using operations such as [`std::distance`](http://www.cplusplus.com/reference/iterator/distance/) to index takes linear time.
