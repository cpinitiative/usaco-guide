...
Adjacency List based off sample test case: <br/>
$1$ $\rightarrow$ $2$, $5$  <br/>
$2$ $\rightarrow$ $1$, $3$, $4$  <br/>
$3$ $\rightarrow$ $2$ <br/>
$4$ $\rightarrow$ $2$ <br/>
$5$ $\rightarrow$ $1$ <br/>

![](<USACO-dec19-milk-visits-silver/graph.png>)
...
1. Farm $A$ and $B$ are part of the same component.  This means the path between $A$ and $B$ only contains cows of the same breed. If the farmer prefers milk from this breed, then we should output $1$.
