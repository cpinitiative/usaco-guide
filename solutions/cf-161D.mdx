...
1. There are length $K$ paths from $a$ to node $b$, in the subtree of $a$.
...
So we want to DFS through the tree, and for each node, calculate the answer for case 1 and case 2.
