...
[Unofficial Editorial (C++)](https://codeforces.com/blog/entry/77128?#comment-637536)
...
Thus, for each query, our answer is simply
...
long long n, q, arr[maxn], prefix[maxn], a, b;
...
void solve() {
	...
	while (q--) {
		cin >> a >> b;
		cout << (prefix[a - 1] xor prefix[b]) << endl;
	}
	return;
}
