...
However, we're missing something! We aren't taking into account any triplets which start at $i$ and end at $j$, since those aren't included in our "PIE-like" transition.
