...
int N, M;
vector<int> adj[50005];	// adj[u] = neighbors of u

int dep[50005];		// dep[u] = depth of u
int par[50005][20];	// par[u][k] = 2^k parent of u
	
int ans[50005];		// ans[u] = amount of milk through u
int S[50005];		// S[u] = # of paths starting at u
int E[50005];		// E[u] = # of paths ending at u
