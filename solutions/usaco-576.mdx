...
int N, M;
vector<int> adj[50001];	// adj[u] = neighbors of u

int dep[50001];		// dep[u] = depth of u
int par[50001][20];	// par[u][k] = 2^k parent of u
	
int ans[50001];		// ans[u] = amount of milk through u
int S[50001];		// S[u] = # of paths starting at u
int E[50001];		// E[u] = # of paths ending at u
