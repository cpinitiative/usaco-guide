...
title: Cities & States
author: Benjamin Qi, Kevin Sheng, Rameez Parwez
---

[Official Analysis (Java)](http://www.usaco.org/current/data/sol_citystate_silver_dec16.html)

## Explanation

Let's represent each given pair as a 4-letter string (city prefix + state code) and use a map to track frequencies.
