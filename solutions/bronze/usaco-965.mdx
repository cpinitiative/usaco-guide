...
author: Benjamin Qi, Kevin Sheng, Melody Yu, Ryan Chou, David Guo
---
...
Since there are only $8$ cows, there are $8! = 40320$ distinct possible orderings, which is small enough for us to try all of them and still pass the problem in time.
