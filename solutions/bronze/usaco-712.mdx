...
int main() {
	...
	// making a new string filtering out al other cows other than the two desired cows
            copy_if(crossings.begin(), crossings.end(), back_inserter(result),
                    [cow1, cow2](char c){ return c == cow1 || c == cow2; });

	// concatenating the two cows into the two strings that feature the two cases
            stringstream ss;
