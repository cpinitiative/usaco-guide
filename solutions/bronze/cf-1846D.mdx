  ...
  public static void main(String[] args) {
    try {
      ...
      for (int testCase = 0; testCase < t; testCase++) {
         ...
         * Main triangle and triangle created by covered area (call it covered triangle)
         ...
         * 
         * Calculate and subtract this covered area from totalArea for each triangle.
         */
        ...
        for (int i = 0; i < n - 1; i++) {
          ...
          if (heightCoveredTriangle > 0) {
            ...
            totalAreaToColor -= (0.5 * heightCoveredTriangle * baseCoveredTriangle);
          }
        }
