...
$M \le 2$ is always true. This is because any two possible substrings (`COW`, `OWC`, `WCO`) share a common substring of at least length 2.
...
Since each operation are having the same characters added for every 3 characters from both halves of the string, each operation will end up as a square string.
