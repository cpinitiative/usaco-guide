...
for which the current pasture is the greater one. We can do this efficiently
by storing the input in [adjacency list](/bronze/intro-graphs#constructing-adjacency-lists)
format.
