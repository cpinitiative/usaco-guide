...
Since the constraint is small, we can store the speed limit as well as Bessie's speed for each mile separately.
Once we have respective speeds, our final answer is the maximum difference between the Bessie's speed and speeding limit for each mile.
