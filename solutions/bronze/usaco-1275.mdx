...
if ((cows[first_guernsey] >= last_guernsey or
        (first_guernsey <= first_holstein and cows[first_guernsey] >= first_holstein)) and
    (cows[first_holstein] >= last_holstein or
        (first_holstein <= first_guernsey and cows[first_holstein] >= first_guernsey))):
    res += 1
