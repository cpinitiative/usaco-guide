...
Let's imagine a case where there is no speed limit at the finish line.

What's the best strategy that Bessie could use? 
</Spoiler>
...
We'll have Bessie continuously speed up until she's forced to slow down because of the speed limit. This strategy works because we've observed that when possible, Bessie should always speed up!
