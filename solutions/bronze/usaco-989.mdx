...
For 1000 queries, our total operations will be $3.16 \times 10^7$,  which should be sufficient to pass all test cases. However, in Python, it will stuck so we have to make some optimizations.
