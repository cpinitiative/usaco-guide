...
author: Óscar Garries, Ryan Chou, Varun Ragunath, David Guo
---
...
Since we know the arrival times and processing times of all cows, we intuitively process them in non-decreasing order of arrival time.
