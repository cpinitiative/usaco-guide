...
As a note on our implementation, the grader for the problem is very particular
when it comes to whitespace: any additional or missing spaces will result in a
WA verdict, even if your code is functionally correct. In addition, some test
...
public class DimaContainers {
	public static void main(String[] args) {
		...
		// if our last operation isn't a 0, we need to process remaining nums
		for (int i = 0; i < nums.size(); i++) { System.out.println("pushBack"); }
