...
title: Don't Be Last
author: Benjamin Qi, Jesse Choe, Kevin Sheng, Rameez Parwez
---

[Official Analysis (Java)](http://www.usaco.org/current/data/sol_notlast_bronze_jan17.html)

## Explanation

Let's first calculate the amount of milk produced by each cow. Next, store these
values in \{amount, cow's name} format in a vector and sort it accordingly. Finally,
we can traverse once to find the name of the cow with the second largest amount of milk.
