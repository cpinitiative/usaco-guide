 ...
 */
bool isInRectangle(int x, int y, int rectBLX, int rectBLY, int rectTRX,
                   int rectTRY) {
...
int main() {
	...
	if (isInRectangle(backBLX, backBLY, frontBLX, frontBLY, frontTRX,
	                  frontTRY)) {
		numCoveredCorners++;
	}
	if (isInRectangle(backTRX, backBLY, frontBLX, frontBLY, frontTRX,
	                  frontTRY)) {
		numCoveredCorners++;
	}
	if (isInRectangle(backTRX, backTRY, frontBLX, frontBLY, frontTRX,
	                  frontTRY)) {
		numCoveredCorners++;
	}
	if (isInRectangle(backBLX, backTRY, frontBLX, frontBLY, frontTRX,
	                  frontTRY)) {
		numCoveredCorners++;
	}
	...
	if (numCoveredCorners <= 1) {
		...
		int totalAreaOfBackRectangle =
		    (backTRX - backBLX) * (backTRY - backBLY);
...
public class Billboard {
	...
	private static boolean covered(int x, int y, int x1, int y1, int x2,
	                               int y2) {
		/*
		 * returns true if (x, y) is covered by the rectangle bounded by
