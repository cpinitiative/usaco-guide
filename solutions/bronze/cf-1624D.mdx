...
Once we are done adding pairs, we can still add one more character to the middle of each palindrome if there are at least `k` individual characters remaining.
