...
There are a variety of ways to approach the problem from here. We could use [small-to-large merging](https://usaco.guide/plat/merging?lang=cpp), but simply using BIT suffices.
