...
public class StuckInARut {
	public static void main(String[] args) throws IOException {
		...
		*/
		...
		for (int x : distances) {
			/* Ternary operator:
			 * basically a condensed if/else statement
			 * variable = (logical expression) ? [set to this value if true] : [set to this value if false];
			 * https://docs.oracle.com/javase/tutorial/java/nutsandbolts/op2.html#:~:text=Another%20conditional%20operator,value2%20to%20result.%22
			 */
