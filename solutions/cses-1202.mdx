...
public class Investigation {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Queue<Pair> toVisit = new PriorityQueue<Pair>();
    ...
    while (!toVisit.isEmpty()) {
      ...
      for (Pair child : adj.get(nodeIdx)) {
        ...
        // with equivalent distance, update num, maxf and minf
          ...
          num[childNode] += num[nodeIdx];
          maxf[childNode] = 
            Integer.max(maxf[childNode], maxf[nodeIdx] + 1);
          minf[childNode] = 
            Integer.min(minf[childNode], minf[nodeIdx] + 1);
        }
      }
    }
    ...
    num[n - 1] %= MOD;
    out.println(
        String.format("%d %d %d %d", dist[n - 1], num[n - 1], 
        minf[n - 1], maxf[n - 1]));
    out.close();
  }
