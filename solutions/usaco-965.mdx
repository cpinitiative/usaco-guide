...
While the solutions provided in the editorial work just fine for the given bounds,
there *is* a solution that works in just $\mathcal{O}(N)$!
...
lexicographical order. When we come upon a cow that could be a possible
...
public class LineUp {
	...
	static final ArrayList<String> COWS = new ArrayList<>(
