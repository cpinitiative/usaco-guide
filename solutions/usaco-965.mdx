...
We can iterate through every possible permutation of cows in lexographic order using `Itertools`. Then we can check for the first permutation that meets the adjacency constraints and this will be our answer. 
