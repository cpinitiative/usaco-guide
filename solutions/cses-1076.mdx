...
## Solution 2: Order Statistic Tree / Fenwick Tree
(Arpan Banerjee)
...
Alternatively, if you do not use C++ (or if you do), you can use a [fenwick tree](https://usaco.guide/gold/PURS?lang=cpp#binary-indexed-tree) to simulate the aforementioned order statistic tree/indexed set:
