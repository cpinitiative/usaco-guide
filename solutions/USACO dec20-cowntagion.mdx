...
The fastest way for COWVID-19 to spread to all the farms is for a farm to have superspreader events until 1 cow can be sent to every adjacent farm. This would start at the root node, and repeat until COWVID-19 has spread to all the farms. 
