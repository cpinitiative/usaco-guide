...
For each query $q$ we can use prefix sums to check the number of occurrences of a given letter $c$ and use two pointers to find the maximum Koyomity ending at a given pointer $p2$ from $0 \dots n$.
