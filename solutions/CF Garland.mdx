...
For each query we can use prefix sums to check the number of occurrences of a given letter $a$ and use two pointers to find the maximum Koyomity ending at a given index $j$.
