...
For each query $q$ we can use prefix sums to check the number of occurrences of a given letter $c_i$ and use two pointers to find the maximum Koyomity ending at a given index $j$ from $0 \dots n$.
