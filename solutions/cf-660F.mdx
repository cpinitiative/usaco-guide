...
The [Official Editorial](https://codeforces.com/blog/entry/44259) uses a divide and conquer approach. However, like many divide and conquer optimization problems, this can also be solved using the [convex hull trick](https://usaco.guide/plat/convex-hull-trick?lang=cpp).
