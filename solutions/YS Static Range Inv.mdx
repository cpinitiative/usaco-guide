...
**Time Complexity:** This solution is $\mathcal{O}(Q\sqrt N)$ as described in the linked [CF Blog](https://codeforces.com/blog/entry/83248) (aka "sweepline mo"). $\mathcal{O}(Q\sqrt N\log N)$ should also be fast enough.
