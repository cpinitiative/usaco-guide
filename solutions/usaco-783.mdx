...
public class Billboard {
	public static void main(String[] args) throws IOException {
		...
		if (numCoveredCorners <= 1) {
			// if 1 or 0 corners are covered, the tarp is the area of the rectangle
			...
			int totalAreaOfBackRectangle = (backTRX - backBLX) * (backTRY - backBLY);
			int areaOfIntersection = (
				(intersectionTRX - intersectionBLX)
	...
	public static boolean isInRectangle(
		int x, int y, int rectBLX, int rectBLY, int rectTRX, int rectTRY
	) {
		return (x >= rectBLX && x <= rectTRX && y >= rectBLY && y <= rectTRY);
	}
}
