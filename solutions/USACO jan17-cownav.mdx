...
However, two additional constriants play a role in this problem: Bessie must be
...
For each pair of cells in the grid, $(x, y)$ and $(x_2, y_2)$, add $16$

<!-- wow that's a lot --> nodes in the graph storing six parameters each:
