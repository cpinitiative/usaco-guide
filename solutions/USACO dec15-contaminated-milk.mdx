...
<LanguageSection>
  <CPPSection>
    ...
    int main(){
      ...
      // Check if it's a possible "sick-making" milk type.
      ...
      // Check whether the possible "sick-making" milk type is consistent with every sick person 
      ...
      // Print the number of sick people
