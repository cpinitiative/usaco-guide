...
title: Berry Picking
author: Qi Wang (Java), Daniel Suh (C++), Juheon Rhee (Python)
---
...
for i in range(1, maximum + 1):
	mod, full, tmp = i, 0, 0
	# where full is representative of the full baskets
	...
	# sorts berries list by maximum mod, so that Bessie can get the maximum amount of leftovers
