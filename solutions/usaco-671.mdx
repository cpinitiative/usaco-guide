...
HORIZ, VERTI = 0, 1  # direction of laser beam (horizontal or vertical)
...
output = -1
queue = deque([(0, HORIZ), (0, VERTI)])  # (idx of fencepost, beam direction)
...
print(output, file=open('lasers.out', 'w'))
```
