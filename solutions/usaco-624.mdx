...
Alternatively, we can also just binary search on the answer without using a PURQ data structure.
 ...
 * partion based on the x coordinate where there are maximum max_cows cows
 * in the region.
