...
dist_bessie = [INF] * n  # min steps for a farmer to reach the node at index i
dist_farmer = [INF] * n  # min steps for bessie to reach the node at index i
