...
To generalise this solution to an arbitrary graph, we simply:
...
Step 2 works because of the fact that all edges that aren't part of the DFS tree are **back-edges** (i.e. edges where one node is a parent of the other). For more information about the DFS tree, read [this CF blog post](https://codeforces.com/blog/entry/68138). 
