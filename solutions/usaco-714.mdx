...
public class HelpCross {
	...
	public static void main (String[] args) throws IOException {
		...
		for (int c = 0; c < numChickens; c++) {
			chickens[c] = io.nextInt();
		}
...
Due to Python's slow speed, the below code will TLE on the last test case.
...
for c in chickens:
	...
	while available_cows and heapq.nsmallest(1, available_cows)[0] < c:
