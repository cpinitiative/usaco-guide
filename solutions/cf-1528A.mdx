...
<Info title="A more math-oriented approach">
Note that [choosing the median minimizes the sum of absolute deviation](https://math.stackexchange.com/questions/85448/why-does-the-median-minimize-ex-c), so we'd want to get as far away from the median as possible.
</Info>
