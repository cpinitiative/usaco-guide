...
Let's go through a case where we've already computed the beauty values for all of vertex $u$'s neighbors.
...
Let's say that we select $7$, can we do better?

The current beauty sum is: $|7-2| + |7-3| + |7-6| + |7-9| = 12$.
