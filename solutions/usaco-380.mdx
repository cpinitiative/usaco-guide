...
// if the location corresponding to row r and column c has 
// been visited atleast once, then visited[r][c]=true
vector<vector<bool>> visited;

// Here, we are dealing with a grid, and for a complete dfs search, we need to 
// call dfs on the adjacent elements of the grid. 
// We will do this by changing the row and column values correspondingly.
// e.g. right => row remains same and column increases by 1. viz. dx=0 and dy=1.
// So, we have maintained two arrays dx and dy for this task
