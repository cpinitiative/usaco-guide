  ...
  return (
    <>
      <div className="sm:hidden">
        ...
        <select
          id="question-tabs"
          className="block w-full rounded-md border-gray-300 dark:border-gray-600 text-base font-medium text-gray-900 dark:bg-gray-800 dark:text-white focus:border-sky-500 dark:focus:border-sky-500 focus:ring-sky-500"
          value={value}
