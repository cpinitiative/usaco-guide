              ...
              <div>
                <div className="grid grid-cols-4 gap-2 mb-4">
                  <div className="text-center">
                    <span className="text-3xl font-bold text-green-800 dark:text-green-100 bg-green-100 dark:bg-green-800 rounded-full h-16 w-16 inline-block inline-flex items-center justify-center">
                      6
                    </span>
                  ...
                  <div className="text-center">
                    <span className="text-3xl font-bold text-yellow-800 dark:text-yellow-100 bg-yellow-100 dark:bg-yellow-800 rounded-full h-16 w-16 inline-block inline-flex items-center justify-center">
                      3
                    </span>
                  ...
                  <div className="text-center">
                    <span className="text-3xl font-bold text-blue-800 dark:text-blue-50 bg-blue-50 dark:bg-blue-800 rounded-full h-16 w-16 inline-block inline-flex items-center justify-center">
                      2
                    </span>
                    <span className="block mt-1 text-sm font-medium uppercase text-blue-800 dark:text-blue-50">
                      Skipped
                    </span>
                  </div>
                  <div className="text-center">
                    <span className="text-3xl font-bold text-gray-800 dark:text-gray-100 bg-gray-100 dark:bg-gray-700 rounded-full h-16 w-16 inline-block inline-flex items-center justify-center">
                      1
                    </span>
