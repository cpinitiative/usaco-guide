            ...
            <div className="flex px-2 lg:px-0">
              ...
              <div className={`hidden lg:ml-8 lg:flex space-x-8`}>
                ...
                <Popover className="h-full">
                  ...
                  <PopoverPanel
                    transition
                    className="hidden md:block z-20 shadow-lg absolute left-1/2 transform -translate-x-1/2 -mt-2 px-2 w-screen max-w-md sm:px-0 lg:max-w-3xl transition data-[closed]:translate-y-1 data-[closed]:opacity-0 data-[enter]:duration-200 data-[leave]:duration-150 data-[enter]:ease-out data-[leave]:ease-in"
                  >
