                      ...
                      <>
                        <Popover.Button
                          className={classNames(
                            ...
                            'group inline-flex items-center space-x-2 text-base leading-6 font-medium p-1 hover:text-gray-900 focus:outline-none focus:text-gray-900 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:rounded-md transition ease-in-out duration-150 dark:text-dark-high-emphasis'
                          )}
                        >
                          <span>Resources</span>
                          <ChevronDownIcon
