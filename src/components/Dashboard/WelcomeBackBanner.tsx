...
export default function WelcomeBackBanner({
  ...
  return (
    <div className="bg-white dark:bg-gray-800 shadow-sm lg:rounded-lg w-full">
      <Link
      ...
      >
        ...
        <div className="mt-5 sm:mt-0 sm:ml-6 sm:shrink-0 sm:flex sm:items-center lg:mr-2">
          <span className="inline-flex rounded-md shadow-sm">
            <span className="inline-flex items-center px-4 lg:px-8 py-2 lg:py-3 border border-transparent text-sm sm:text-base lg:text-lg font-medium rounded-md text-white bg-blue-800 hover:bg-blue-600 dark:hover:bg-blue-700 focus:outline-hidden focus:border-blue-700 focus:shadow-outline-blue active:bg-blue-700 transition ease-in-out duration-150">
              {lastViewedModuleURL
