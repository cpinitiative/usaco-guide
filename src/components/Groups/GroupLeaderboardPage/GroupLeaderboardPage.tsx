...
export default function GroupLeaderboardPage(props: { path: string }): JSX.Element {
  ...
  return (
    <Layout>
      <SEO title={`Leaderboard: ${activeGroup.groupData!.name}`} image={null} pathname={props.path} />
