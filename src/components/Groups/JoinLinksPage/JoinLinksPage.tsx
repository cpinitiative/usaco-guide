...
const JoinLinksPage = () => {
  ...
  if (!activeGroup.showAdminView) {
    return (
      <Layout>
        <SEO title="403 Forbidden" image={null} pathname={window.location.pathname} />
        <TopNavigationBar />
  ...
  return (
    <Layout>
      <SEO title={`Join Links: ${activeGroup.groupData!.name}`} image={null} pathname={window.location.pathname} />
