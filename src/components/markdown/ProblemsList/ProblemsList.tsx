            ...
            <table className="w-full no-markdown">
              <thead>
                <tr>
                  ...
                  <th className="pl-4 pr-4 md:px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                    Solution
                  </th>
                </tr>
              </thead>
