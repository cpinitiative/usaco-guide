...
export default function ProblemsListHeader(props: ProblemsListHeaderProps) {
  return (
    <tr className='bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 pr-4 md:pr-6'>
      ...
      <th
        className='pl-4 sm:pl-10 md:pl-12 md:pr-6 py-3 text-left text-xs leading-4 font-medium uppercase tracking-wider whitespace-nowrap'>
        Problem Name
      </th>
      ...
      (props.isDivisionTable ? (
        props.showSolvePercentage && (
          <th
            className='pl-4 md:pl-6 pr-4 md:pr-6 py-3 text-left text-xs leading-4 font-medium uppercase tracking-wider'>
            <TextTooltip
              content={
