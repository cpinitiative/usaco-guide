          ...
          <div className="bg-white">
            ...
            <div className={containerClasses}>
              ...
              <p className={subtextClasses}>
                Stop wasting time searching for problems and tutorials. The
                USACO Guide provides a{' '}
                <b className="text-black">comprehensive, organized roadmap</b>{' '}
                carefully designed and crafted for USACO contestants – available
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <g
                            id="头部"
                            transform="translate(6.000000, -273.000000)"
                          >
                            <g
                              id="logo"
                    ...
                    <div className="mt-12">
                      ...
                      <dd className="mt-2">
                        <p className="text-base leading-6dark:text-gray-400">
                          ...
                          makes no guarantees about the topics in future USACO
                          contests.
                        </p>
                      </dd>
                    </div>
