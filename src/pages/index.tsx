    ...
    <Layout>
      ...
      <div className="bg-gray-100 dark:bg-black">
        ...
        <div className={containerClasses}>
          ...
          <div className="my-8 grid grid-cols-1 space-y-5 sm:space-y-0 sm:grid-cols-2 items-center gap-4 text-gray-600 md:grid-cols-3 lg:my-6 lg:grid-cols-4 dark:text-gray-400">
