          ...
          <main className="mt-8 mx-auto max-w-6xl px-4 sm:mt-12 sm:px-6 md:mt-20 xl:mt-24">
            <div className="lg:grid lg:grid-cols-12 lg:gap-8">
              <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:flex-col lg:justify-center">
                <div
                  className="text-sm font-semibold uppercase tracking-wide text-gray-500 sm:text-base lg:text-sm xl:text-base">
                  Pre-Release
                </div>
                <h2
            ...
            <ul className="md:grid md:grid-cols-2 md:col-gap-8 md:row-gap-10">
              ...
              <li className="mt-10 md:mt-0">
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg leading-6 font-medium text-gray-900">Officially Recognized</h4>
                    <p className="mt-2 text-base leading-6 text-gray-500">
            ...
            <dl className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <div className="mt-12">
                  ...
                  <dd className="mt-2">
                    <p className="text-base leading-6 text-gray-500">
                      If you would like to contribute towards this guide or report an issue, please contact Nathan Wang at <a className="text-blue-600 underline" href="mailto:nathan.r.wang@gmail.com">nathan.r.wang@gmail.com</a>.
                    </p>
                  </dd>
                </div>
              </div>
