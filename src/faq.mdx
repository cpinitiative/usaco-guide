...
## Q: Is there an age requirement for USACO?

No! While most people take USACO during high school, there are people who have taken USACO in middle school and even in elementary school. You can start preparing for it now with [USACO Guide](https://usaco.guide/)!
...
USACO's contest rules can be found [here](http://www.usaco.org/index.php?page=instructions). Please keep those rules in mind during contest as they can have serious consequences!
...
## Q: What are the USACO problem constraints?

There is a time constraint for each problem you submit. It is different for different langauges as some langauges run slower than others. The second constraint is a memory constraint. USACO allows 256 MB for every solution with more allocated for Java because of JVM. The specifics can be found [here](http://www.usaco.org/index.php?page=instructions).
