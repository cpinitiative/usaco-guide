...
We recommend you join the [(unofficial) USACO Forum](https://forum.usaco.guide/) to get help when you're stuck. Alternatively, you can join the [(unofficial) USACO Discord Server](https://discord.com/invite/bessMBe). They have channels called #cp-discussion and #cp-help specifically dedicated to questions about competitive programming.
...
- USACO Bronze users are probably <1300 rated on CF, and Bronze problems correspond to 900-1500 rated CF problems.
- USACO Silver users are probably 1200-1500 rated on CF, and Silver problems correspond to 1200-1900 rated CF problems.
- USACO Gold users are probably 1500-1800 rated on CF, and Gold problems correspond to 1500-2200 rated CF problems.
- USACO Platinum users are probably 1650+ rated on CF, and Platinum problems correspond to 1900+ rated CF problems. (Note that at the Platinum level there is a _lot_ of variation in CF ratings.)
