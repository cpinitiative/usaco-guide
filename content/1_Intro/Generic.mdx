...
<Warning>
You are not allowed to use pre-written code for USACO contests! This module should only be applied for online contests which do allow prewritten code, like Codeforces.
</Warning>
