...
You can find my template [here.](https://github.com/bqi343/USACO/blob/master/Implementations/content/contest/template.cpp)
...
<Resources>
  ...
  <Resource source="SO" title="How does #include <bits/stdc++.h> work in C++?" url="https://stackoverflow.com/questions/25311011/how-does-include-bits-stdc-h-work-in-c/25311052#25311052"> </Resource>
...
<Resources>
  <Resource source="SO" title="Why should I not #include <bits/stdc++.h>?" url="https://stackoverflow.com/questions/31816095/why-should-i-not-include-bits-stdc-h" starred>wow, people are really mad about this!</Resource>
  <Resource source="SO" title="#include <bits/stdc++.h> with visual studio does not compile" url="https://stackoverflow.com/questions/25337300/include-bits-stdc-h-with-visual-studio-does-not-compile"> </Resource>
</Resources>
...
<Resources>
  <Resource source="SO" title="How can I include <bits/stdc++.h> in XCode?" url="https://stackoverflow.com/questions/28994148/how-can-i-include-bits-stdc-in-xcode">solutions that may or may not work</Resource>
</Resources>

## `typedef`, `using`

<Resources>
  <Resource source="LearnCPP" title="6.13 - Typedefs and type aliases" url="https://www.learncpp.com/cpp-tutorial/typedefs-and-type-aliases/" starred> </Resource>
  <Resource source="Quora" title="Difference between 'typedef' and 'using' in C++?" url="https://www.quora.com/What-is-the-difference-between-typedef-and-using-in-C++"> </Resource>
</Resources>

## Macros

<Resources>
  <Resource source="CPH" title="1.4 - Shortening Code" starred>simple examples of macros, describes a common bug</Resource>
  <Resource
    source="GNU"
    url="https://gcc.gnu.org/onlinedocs/cpp/Macros.html"
    title="GCC Online Docs - Macros"
  >
    reference
  </Resource>
...
If you use too many macros then your code will become unreadable to anyone besides yourself! :D
...
<Resources>
  <Resource source="LearnCPP" title="13.1 - Function Templates" url="https://www.learncpp.com/cpp-tutorial/131-function-templates/" starred> </Resource>
</Resources>
...
<Resources>
  <Resource source="LearnCPP" title="13.3 - Template Classes" url="https://www.learncpp.com/cpp-tutorial/133-template-classes/" starred> </Resource>
  <Resource source="CPP" title="Type Alias" url="https://en.cppreference.com/w/cpp/language/type_alias">documention for using</Resource>
</Resources>

Can also use with `using` (check documentation for details).
