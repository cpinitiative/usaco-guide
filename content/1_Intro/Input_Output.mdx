...
For all subsequent modules, `#include <bits/stdc++.h>` will be used in place of separately including libraries.
...
Note that this problem requires 64-bit integers (`long long` in C++, `long` in Java).
...
```cpp
#include <iostream> // or just <bits/stdc++.h>
using namespace std;
...
```cpp
#include <cstdio> // or just <bits/stdc++.h>
using namespace std;
...
```cpp
#include <fstream> // or just <bits/stdc++.h>
using namespace std;
