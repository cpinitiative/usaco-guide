...
The first method can be sped up so that the difference in speed is not significant; see [Fast I/O](./fast-io) for details.
...
The print() method takes in a string and an optional "end" character (defaults to '\n').
...
<Resources>
    <Resource source="GCP" title="1.3 -  CSES Problem Set" starred>example solution for this problem</Resource>
</Resources>
...
**Note:** If you went through the recommended sections of Sololearn from [Choosing a Language](./choosing-lang#resources-for-learning-how-to-code), then you should be able to implement this yourself.
...
The most intuitive way to do file IO in python is by redirecting the system input and output to files. After doing this,
you can then use the above input() and print() methods as usual.
