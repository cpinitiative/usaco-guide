...
<resources title="Integrated Development Environments">
  <resource title="Visual Studio Code" url="https://code.visualstudio.com/" starred>
    Lightweight, fast IDE, but requires some configuration. See <a href="http://www.csc.kth.se/~jsannemo/slask/main.pdf">PAPC Ch 2.1</a> for setup instructions.
  </resource>
  ...
  <resource title="Geany" url="https://www.geany.org/">
    Ben: I used at IOI
  </resource>
  ...
  <resource title="CLion" url="https://www.jetbrains.com/clion/" starred>
    requires a license, but <a href="https://www.jetbrains.com/community/education/#students">free for students</a>
  </resource>
</resources>
