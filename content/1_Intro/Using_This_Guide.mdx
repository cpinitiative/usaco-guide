...
- Adding / expanding a specific module
- Fixing general issues (improving descriptions, phrasing, problem sets, etc)
- Participating in user studies (use the guide and give us specific recommendations about what can be improved)
