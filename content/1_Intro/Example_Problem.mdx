...
export const metadata = {
  problems: {
    general: [
      new Problem("USACO", "Promotion Counting", "591", "Intro"),
      new Problem("USACO", "Word Processor", "987", "Intro"),
      new Problem("USACO", "Square Pasture", "663", "Intro"),
      new Problem("USACO", "Bucket Brigade", "939", "Intro"),
    ]
  }
};
