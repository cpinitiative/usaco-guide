...
I use the following in my `.zshenv` to compile and run.
...
<Resources>
	<Resource source="GCC" title="Program Instrumentation Options" url="https://gcc.gnu.org/onlinedocs/gcc/Instrumentation-Options.html">documentation for -fsanitize</Resource>
	<Resource source="GCC" title="Using Debug Mode" url="https://gcc.gnu.org/onlinedocs/libstdc++/manual/debug_mode_using.html#debug_mode.using.mode">documentation for -D_GLIBCXX_DEBUG</Resource>
</Resources>
