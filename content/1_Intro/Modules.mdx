...
All implementations should compile, have example input / output provided, and have relatively few macros. If any code does not compile or is hard to read, submit a complaint using the "Contact Us" tab.
  ...
  - For Bronze, Silver, and Gold, we will provide code snippets in C++, Java, and sometimes Python. Implementations in Python will generally become less frequent moving up divisions.
  - For Platinum, code snippets will be provided in C++ and sometimes Java.
