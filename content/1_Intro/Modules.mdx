...
- "**Hard**" refers to a problem which may take a lot of time to approach. However, if someone has done a large number of "Normal" problems and has a strong understanding of a topic, could theoretically be solved during a USACO contest.
...
- "**Insane**" refers to problems that are misplaced in their division. These problems are often a bad representation of the difficulty of problems in a USACO division. If you want a challenge, try them out.
