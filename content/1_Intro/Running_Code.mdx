...
<Resources>
  ...
  <Resource title="Vim" url="https://www.vim.org/" starred>
...
- [Package - Fast Olympic Coding](https://github.com/Jatana/FastOlympicCoding) (I don't use)
  ...
  - stress testing is covered in [Debugging](./debugging)
...
[USACO](http://www.usaco.org/index.php?page=instructions) (and most contests) use [GCC](https://en.wikipedia.org/wiki/GNU_Compiler_Collection)'s `g++` to compile and run your code. You'll need `g++` specifically to use the `#include <bits/stdc++.h>` header file within the template provided in [Code Conventions](./code-con#template); see [C++ Tips & Tricks](./cpp-tips#include-bitsstdch) for details.
...
<Resources>
  <Resource source="Jetbrains" title="Configuring CLion on Windows" url="https://www.jetbrains.com/help/clion/quick-tutorial-on-configuring-clion-on-windows.html#MinGW">setting up Cygwin, MinGW, WSL, or MSVC</Resource>
</Resources>

#### [MinGW](http://mingw.org/) (Minimalist GNU for Windows)

<Resources>
  <Resource source="Microsoft" title="VSCode - GCC on Windows" url="https://code.visualstudio.com/docs/cpp/config-mingw">MinGW</Resource>
  <Resource source="Rose-Hulman" title="Adding MinGW to PATH" url="https://www.rose-hulman.edu/class/csse/resources/MinGW/installation.htm"> </Resource>
</Resources>
...
<Resources>
  <Resource source="Microsoft" title="VSCode - GCC on WSL" url="https://code.visualstudio.com/docs/cpp/config-wsl">difficult for beginners</Resource>
</Resources>
...
<Resources>
	<Resource source="SO" url="https://stackoverflow.com/questions/45023243/displaying-or-redirecting-a-shells-job-control-messages" title="Displaying or redirecting a shell's job control messages"> </Resource>
</Resources>
...
<Resources>
	<Resource source="CF" title="How to Find Total Memory Consumption of C++ Program" url="https://codeforces.com/blog/entry/49371?#comment-333749">for Linux</Resource>
	<Resource source="SO" title="time -v on Mac" url="https://stackoverflow.com/questions/32515381/mac-os-x-usr-bin-time-verbose-flag">use gtime</Resource>
</Resources>
...
<Resources>
	<Resource source="Wikipedia" url="https://en.wikipedia.org/wiki/Stack_overflow" title="Stack overflow">explanation of the issue</Resource>
	<Resource source="CF" url="https://codeforces.com/blog/entry/60999?#comment-449312" title="Solving on Mac"> </Resource>
</Resources>
...
<Resources>
  <Resource source="Microsoft" title="Visual Studio Code" url="https://code.visualstudio.com/" starred>
    More lightweight than Visual Studio Community, requires some configuration. See{' '}
    <a href="http://www.csc.kth.se/~jsannemo/slask/main.pdf">PAPS 2.1</a> for
    setup instructions.
  </Resource>
  ...
  <Resource source="Code::Blocks" title="Code::Blocks" url="http://www.codeblocks.org/">
    Windows & Linux. <a href="https://codeforces.com/blog/entry/61780">Apparently</a> was unstable at IOI.
  </Resource>
  ...
  <Resource source="Microsoft" title="Visual Studio Community" url="https://visualstudio.microsoft.com/vs/">
    Windows. Heavier cousin of Visual Studio Code (which is better for competitive programming).
  </Resource>
  <Resource source="Eclipse" title="C/C++ IDE" url="https://www.eclipse.org/downloads/packages/release/2020-06/r/eclipse-ide-cc-developers"> </Resource>
</Resources>
