...
Adding this line as the first line of `main()` reduced the runtime of the first method to 254 ms.  See [this CodeForces blog](https://codeforces.com/blog/entry/5217) and [StackOverflow](https://stackoverflow.com/questions/31162367/significance-of-ios-basesync-with-stdiofalse-cin-tienull) for more information. 
