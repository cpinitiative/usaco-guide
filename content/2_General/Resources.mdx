...
## Books
  ...
  - Intro to USACO - Darren Yao 
    ...
    - [Spreadsheets - USACO Monthly Problems](https://darren-yao.gitbook.io/darren-s-blog/usaco-faq#what-should-i-use-to-keep-track-of-which-usaco-problems-ive-done)
