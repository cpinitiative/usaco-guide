...
When passing by value (the first example), you can only access the (key, value) pairs. When you pass by reference (second example), if you modify the pairs you iterate through, it changes in the actual map as well.
