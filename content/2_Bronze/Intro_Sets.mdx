...
The values in the map are pairs of (key, value). We use the `auto` keyword so you can iterate over any type of key and value in the pairs. You can use these pairs normally, as introduced in [this module](https://usaco-guide.vercel.app/bronze/intro-ds).
