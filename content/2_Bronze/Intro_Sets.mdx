...
The values in the map are pairs in the form `{key, value}`. We use the `auto` keyword to iterate over any type of key and value in the pairs. You can use these pairs normally, as introduced in [this module](/bronze/intro-ds#pairs--tuples).
