...
<Quiz>
  <Quiz.Question>
    What is the time complexity of insertions, deletions, and searches in an ordered set?
    <Quiz.Answer>
      $\mathcal{O}(1)$
      <Quiz.Explanation>
  ...
  <Quiz.Question>
    If a set s contains the elements {1, 2, 4, 5}, which of the following is equivalent to s.count(3)?
    <Quiz.Answer>
      1
      <Quiz.Explanation>
        The element 3 isn't contained in s, so the output should be 0, since count is supposed to output 1 when the element is present in the set and 0 when the element isn't present in the set.
      </Quiz.Explanation>
    </Quiz.Answer>
    <Quiz.Answer correct>
      0
  ...
  <Quiz.Question>
    If a set s has the elements [4, 1, 2, 1, 3, 2, 3, 1, 3, 1] inserted into it, which of the following is equivalent to s.size()?
    <Quiz.Answer>
      1
      <Quiz.Explanation>
        There are a total of 4 unique numbers inserted into s, so the answer is 4.
      </Quiz.Explanation>
    </Quiz.Answer>
    <Quiz.Answer correct>
      4
  ...
  <Quiz.Question>
    A map is a set of ordered pairs containing which of the following?
    <Quiz.Answer>
      A key and element
      <Quiz.Explanation>
  ...
  <Quiz.Question>
    What is the time complexity of insertions, deletions, and removals in an ordered map?
    <Quiz.Answer>
      $\mathcal{O}(1)$
      <Quiz.Explanation>
  ...
  <Quiz.Question>
    If a map m contains the elements [(1, 5), (2, 9), (3, 7), (4, 3)], which of the following is equivalent to m[2]?
    <Quiz.Answer>
      5
      <Quiz.Explanation>
        The value associated with the key 2 is 9.
      </Quiz.Explanation>
    </Quiz.Answer>
    <Quiz.Answer correct>
      9
  ...
  <Quiz.Question>
    If a map m contains the elements [(1, 5), (2, 9), (3, 7), (4, 3)], which of the following is equivalent to m[2] after m.erase(2) is called?
    <Quiz.Answer correct>
      0
      <Quiz.Explanation>
        Since the key 2 isn't present in m after the removal of 2, m[2] is 0 after m.erase(2) is called.
      </Quiz.Explanation>
    </Quiz.Answer>
    <Quiz.Answer>
      9
  ...
  <Quiz.Question>
    Which of the following represents the type of element used to iterate over an ordered map containing integers?
    <Quiz.Answer>
      Integer
      <Quiz.Explanation>
        A map contains a pair containing key and value.
      </Quiz.Explanation>
    </Quiz.Answer>
    <Quiz.Answer correct>
      Pair of integers
