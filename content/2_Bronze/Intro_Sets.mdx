...
[custom hash function](https://usaco.guide/gold/unordered-map#custom-hashing)
...
a [custom hash function](https://usaco.guide/gold/unordered-map#custom-hashing)
for custom classes.
...
<Quiz>
  ...
  <Quiz.Question>
    What is the time complexity of insertions, deletions, and removals in an unordered map of size $N$?
    <Quiz.Answer correct>
      $\mathcal{O}(1)$
			<Quiz.Explanation>
				Correct.
...
<Quiz>
  ...
  <Quiz.Question>
    Which of the following is the correct output of this code?
		```java
		Integer[] arr = {4, 1, 2, 1, 3, 2, 3, 1, 3, 1};
