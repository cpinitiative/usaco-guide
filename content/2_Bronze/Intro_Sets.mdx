...
Bronze problems are designed that you shouldn't need to sort, though the concept can come in very handy for some problems.
...
Colloquially, maps are referred to as **dicts** in python. They act as hash maps, so they actually have
$O(1)$ insertion, deletion, and searches.
