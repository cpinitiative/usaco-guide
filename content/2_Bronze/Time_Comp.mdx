...
<Resources>
	...
	<Resource source="YouTube" title = "Introduction to Algorithms" url="https://www.youtube.com/watch?v=-dOcsV7pmzQ&list=PLtLxhThTxJMVMvWJoE2p8Z84tA8suGzvn&index=1">
		Another video source to help you understand Time Complexity with respect to USACO. Start at time 5:58 and end at time 9:04.
	</Resource>
</Resources>

<Optional title="P vs. NP">

If you're interested in learning more about P vs. NP, check out this [Youtube video](https://www.youtube.com/watch?v=YX40hbAHx3s). If you're just starting out, you may want to skip this video for now.
