...
If you're interested in learning more about P vs. NP, check out this [Youtube video](ttps://www.youtube.com/watch?v=YX40hbAHx3s). If you're just starting out, you may want to skip this video for now.
