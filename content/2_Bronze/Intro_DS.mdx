...
Notice how you can create infinite loops with doubly-linked lists. Doubly-linked lists can be used to represent successor graphs. You can read more about successor graphs [here.](https://usaco.guide/silver/func-graphs)
