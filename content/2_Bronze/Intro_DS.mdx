...
{/* Usually, the choice between a static array and a dynamic array is just
personal preference. */}
...
{/* This is not frequently used by competitive programmers, but it is good to
know and can help simplify things sometimes. */}
...
{/* Python automatically sorts a list of tuples by the first element, then the
