...
export const problems = {
	bubble: [
		new Problem(
			...
			false,
			[],
			"Implement the Bubble Sort algorithm. Read any of the resources if you don't know how to do that, or just google."
		),
	],
	easy: [
		new Problem(
...
<Resources>
	<Resource source="CPH" title="3.1 - Sorting Theory">
	</Resource>
	<Resource source="CSA" title="Sorting" url="sorting"> </Resource>
</Resources>
...
<Resources>
	...
	<Resource source="CF" title="C++ Tricks" url="blog/entry/74684">
...
what about USACO problems? (though sorting is *very* rare in Bronze)
