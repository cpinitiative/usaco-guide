...
{/_ Usually, the choice between a static array and a dynamic array is just
...
{/_ END C++ SECTION ON ARRAYS _/}

{/_ BEGIN JAVA SECTION ON ARRAYS _/}
...
{/_ END JAVA SECTION ON ARRAYS _/}

{/_ BEGIN PYTHON SECTION ON ARRAYS _/}
...
{/_ END PYTHON SECTION ON ARRAYS _/}

</LanguageSection>

{/_ END SECTION ON ARRAYS _/}
...
{/_ This is not frequently used by competitive programmers, but it is good to
know and can help simplify things sometimes. _/}
...
{/_ Python automatically sorts a list of tuples by the first element, then the
second, and so on. This can save you time and keystrokes for certain problems
like the one above. _/}
...
{/_ Unless someone has any. I really can't find anything... _/}
