...
export const problems = {
	easier: [
		...
		new Problem('Bronze', 'Hoof Paper Scissors', '688', 'Easy', false, []),
		new Problem('Bronze', 'The Bovine Shuffle', '760', 'Easy', false, []), // 100
		new Problem('Bronze', 'The Bucket List', '856', 'Easy', false, []),
		new Problem(
			'Bronze',
	...
	harder: [
		...
		new Problem('Bronze', 'Block Game', '664', 'Normal', true), // 97.41
		new Problem('Bronze', 'Team Tic Tac Toe', '831', 'Normal'), // 97.41
		new Problem('Bronze', 'Cow Queue', '713', 'Normal', true, []), // 97.59
		new Problem('Bronze', 'Mowing the Field', '593', 'Normal', false, []), // 97.16
		new Problem('Bronze', 'Contaminated Milk', '569', 'Normal', true, []), // 95.97
		new Problem('Bronze', 'Milk Measurement', '761', 'Hard'), // 95.97
		new Problem('Bronze', 'Angry Cows', '592', 'Hard', true, [], ''), // 94.15
	],
};
...
A lot of these are not very interesting, so don't feel the need to do all of them.
