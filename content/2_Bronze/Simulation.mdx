...
export const problems = {
	easier: [
		...
		new Problem('Bronze', 'Hoof Paper Scissors', '856', 'Easy', false, []),
		new Problem('Bronze', 'Why Did the Cow Cross the Road', '711', 'Easy', false, []),
	],
	harder: [
		...
		new Problem('Bronze', 'Cowntact Tracing', '1037', 'Easy', false, []),
