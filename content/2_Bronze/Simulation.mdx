...
export const problems = {
    easier: [
      ...
      new Problem("Bronze", "Speeding", "568", "Easy", true, ["Nested Loop"], "store speed for each mile", "usaco-568"), // 99.05
    ...
    harder: [
      ...
      new Problem("Bronze", "Team Tic Tac Toe", "831", "Normal", "usaco-831"), // 97.41
      ...
      new Problem("Bronze", "Milk Measurement", "761", "Hard", "usaco-761"), // 95.97
