...
author: Michael Cao
description: 'Problems that do not fall into standard categories with well-studied solutions.'
frequency: 1
---
...
In this module, we'll go over some general tips that may be useful in approaching problems that _appear_ to be ad hoc.
...
- Try to approach the problem from a lot of different perspectives. Try to mess around with formulas or draw a visual depiction of the problem (maybe some sort of [graph](/bronze/intro-graphs)). One of the most helpful things you can do when solving ad hoc problems is to keep trying ideas until you make progress. This is something you get better at as you do more problems.
...
Of course, ad hoc problems can be [quite easy](/general/expected#problem-http://www.usaco.org/index.php?page=viewproblem2&cpid=591), but the ones presented below are generally on the harder side.
