...
There are 3 cases for the minimum, each having their own $\mathcal{O}(1)$ solution.
...
Therefore, the maximum is just the largest gap between two adjacent elements minus 1.
This can be observed by drawing a lot of cases.
