...
[quite easy](/general/expected#problem-http://www.usaco.org/index.php?page=viewproblem2&cpid=591),
but the ones presented below are generally on the harder side.
