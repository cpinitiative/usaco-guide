...
<Quiz>
  <Quiz.Question>
    ...
    <Quiz.Answer>
      An algorithm which takes back choices in order to find the most optimal solution.
      <Quiz.Explanation>
        Incorrect. A greedy algorithm doesn't take back choices. Instead, it directly constructs an answer.
      </Quiz.Explanation>
    </Quiz.Answer>
    <Quiz.Answer correct>
    ...
    <Quiz.Answer>
      ...
      <Quiz.Explanation>
        Incorrect. This is known as [complete search](https://usaco.guide/bronze/intro-complete) or [brute force](https://usaco.guide/bronze/intro-complete).
      </Quiz.Explanation>
    </Quiz.Answer>
  </Quiz.Question>
  <Quiz.Question>
