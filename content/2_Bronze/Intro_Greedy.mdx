...
<Quiz>
  <Quiz.Question>
    ...
    <Quiz.Answer>
      ...
      <Quiz.Explanation>
        Incorrect. A greedy algorithm doesn't backtrack. Instead, it directly constructs an answer.
      </Quiz.Explanation>
    </Quiz.Answer>
    <Quiz.Answer correct>
      An algorithm which makes the most optimal choice at each step.
      <Quiz.Explanation>
        Correct. This allows a greedy algorithm to be very efficient.
      </Quiz.Explanation>
    </Quiz.Answer>
    <Quiz.Answer>
      An algorithm which tries every possible combination in order to find the most optimal outcome.
      <Quiz.Explanation>
        Incorrect. This is known as complete search or brute force.
      </Quiz.Explanation>
    </Quiz.Answer>
  </Quiz.Question>
  <Quiz.Question>
    Why would a greedy algorithm be preferred over a complete search algorithm when faced with a large dataset? 
    <Quiz.Answer correct>
  ...
  <Quiz.Question>
    ...
    <Quiz.Answer>
      It's a substitute for other algorithms.
      <Quiz.Explanation>
        Incorrect.
      </Quiz.Explanation>
    </Quiz.Answer>
