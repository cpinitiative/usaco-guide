...
export const problems = {
    tutorial: [
      new Problem("Bronze", "Mad Scientist", "1012", "Easy", false, [], "See below."),
    ],
    general: [
