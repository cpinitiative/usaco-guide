...
contributors: Allen Li, Andrew Wang, Dong Liu, Ryan Chou, Salma Jama
description:
...
![](content/2_Bronze/assets/rect_example.png)
...
![](content/2_Bronze/assets/rect_width.png)
![](content/2_Bronze/assets/rect_length.png)
