...
[java.awt.geom.Area](https://docs.oracle.com/javase/7/docs/api/java/awt/geom/Area.html) will allow you to calculate the intersections of arbitrary polygons (and more).
