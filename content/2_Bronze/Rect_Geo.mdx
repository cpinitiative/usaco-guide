...
First, we notice that rectangles can be represented by $2$ points each, the top right and 
the bottom left. We'll call these points $tr_a$ and $tr_b$, and $bl_a$ and $bl_b$, for rectangles 
$a$ and $b$. 
