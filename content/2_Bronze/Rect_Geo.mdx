...
Code runs marginally faster in Python when placed in a function
(see [this](https://stackoverflow.com/questions/11241523/why-does-python-code-run-faster-in-a-function) SO thread),
so we can use this to get all 10 test cases - when taken out of
the function, the code passes only 9.
