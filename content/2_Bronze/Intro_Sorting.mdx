...
<Quiz.Question>
  ...
  <Quiz.Question>
	What is the average time complexity of mergesort?
	<Quiz.Answer correct>
	  $\mathcal{O}(n\log{}n)$
	  <Quiz.Explanation>
	...
	<Quiz.Answer>
	  $\mathcal{O}(\log{}n)$
	  <Quiz.Explanation>
	  Incorrect. It is impossible to have more efficient sorting algorithms than $\mathcal{O}(\n)$.
	  </Quiz.Explanation>
	</Quiz.Answer>
  </Quiz.Question>
  <Quiz.Question>
	Every comparison sort must satisfy the requirement of transitivity:
	if $a \leq b$ and $b \leq c$ then $a \leq c$. 
	
	Does the custom comparator code snippet for pairs (x, y) fulfill this criteria?
	```cpp
bool cmp(int a, int b) {
	...
	<Quiz.Answer>
	  Yes
	  <Quiz.Explanation>
	   Incorrect. For instance if there is an array [1, 2, 3], then according to the comparator, in comparing 3 and 1, 3 < 1,  and in comparing 1 and 2, 1 < 2.
	   
According to transitivity, in comparing 3 and 2, 3 < 2 should be true. 

However, 3 > 2. So this does not fulfill transitivity.
	  </Quiz.Explanation>
	</Quiz.Answer>
	...
	<Quiz.Answer correct>
	  No
	  <Quiz.Explanation>
	  Correct. For instance if there is an array [1, 2, 3], then according to the comparator, in comparing 3 and 1, 3 < 1,  and in comparing 1 and 2, 1 < 2.
