...
Make sure run using PyPy 3. Program will run out of time and/or memory unless you do.
...
Without rounding, this code would fail on the following test case (it outputs $12.999999999999998$, but the answer is $13$):
