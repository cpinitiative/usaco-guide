...
export const problems = {
	sample: [new Problem('CF', 'Maximum Distance', 'https://codeforces.com/gym/102951/problem/A', 'Easy', false, [])],
	probs: [
		new Problem(
			'Bronze',
			'Milk Pails',
		...
		new Problem('Bronze', 'Why Did the Cow Cross the Road II', '712', 'Normal', true, ['Nested Loop'], 'usaco-712'), // 89.6
		...
		new Problem('Bronze', 'Contaminated Milk', '569', 'Very Hard', false, [], 'usaco-569'),
		new Problem('Bronze', 'Cowntact Tracing', '1037', 'Very Hard', true, [], ''),
		new Problem(
			'Bronze',
