...
<Resources>
	<Resource source = "YouTube" title = "Graph Representations" url = "https://www.youtube.com/watch?v=XZGsBUgmeXc&list=PLtLxhThTxJMVMvWJoE2p8Z84tA8suGzvn&index=4">
		A video that explains what graphs are, the different types of graphs, and the different ways to represent them using code. He briefly describes how to represent these graphs in C++ as well as how they will be represented in USACO problems.	
	</Resource>
</Resources>
