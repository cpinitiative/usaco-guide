...
prerequisites:
  - prefix-sums
description: 'Introduces Segment Tree, Binary Indexed Tree, and C++ Order Statistic Tree.'
frequency: 3
---
...
export const problems = {
	...
	usaco: [
		new Problem('Gold', 'Haircut', '1041', 'Easy', true, ['PURS', 'Inversions'], 'usaco-1041'),
		new Problem('Gold', 'Balanced Photo', '693', 'Easy', false, ['PURS', 'Inversions'], 'usaco-693'),
		new Problem('Gold', 'Circle Cross', '719', 'Easy', false, ['PURS', 'Inversions'], ''),
		new Problem('Gold', 'Sleepy Cow Sort',
			'898',
			'Easy',
			false,
			['PURS'],
		...
		new Problem('Plat', 'Mincross', '720', 'Easy', false, ['PURS', 'Inversions'], ''),
		new Problem('Old Gold', 'Cow Hopscotch', '532', 'Hard', false, ['PURS'], ''),
	],
};
...
<Resources>
	<Resource source="CF" title="EDU: Segment Tree Pt 1 Steps 1, 3, 4" url="https://codeforces.com/edu/course/2/lesson/4/1" starred>basic operations, inversion counting</Resource>
