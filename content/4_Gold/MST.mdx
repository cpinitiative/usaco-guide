...
The below implementation uses a priority-queue and has complexity $O(E \log E)$. To improve to $O(E \log V)$, use a TreeSet to update the distances rather than 
re-adding them.
