...
contributors: Neo Wang, Aadit Ambadkar
prerequisites:
  - shortest-paths
  - dsu
description:
...
Prim's Algorithm is guaranteed to find the MST given that no edges have negative weight. This is intuitively true, but several formal and rigerous proofs are given below:

<Resources>
	<Resource
		source="Michael Dinitz (JHU)"
		url="https://www.cs.jhu.edu/~mdinitz/IntroAlgorithms/Lectures/lecture14.pdf"
		title="Proof of Prim's Algorithm"
	>
		Minimum Spanning Trees
	</Resource>
	
	<Resource
		source="Stephen R. Tate (UNCG)"
		url="https://www.uncg.edu/cmp/faculty/srtate/330.f16/primsproof.pdf"
		title="Proof of Correctness for Prim's Algorithm"
	>
		Proof of Prim's
	</Resource>
</Resources>
