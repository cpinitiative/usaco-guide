...
export const problems = {
	...
	general: [
		...
		new Problem(
			'IOI',
			'2016 - Rollercoaster Railroad',
			'https://oj.uz/problem/view/IOI16_railroad',
			'Very Hard',
			true,
			['MST'],
			''
		...
		new Problem(
			'Balkan OI',
			'2011 - Timeismoney',
			'http://oj.uz/problem/view/balkan11_timeismoney',
			'Insane',
			true,
			['MST', 'Convex Hull'],
			''
