...
of advanced stuff you don't need to know at this level</Resource> */}
...
otherwise, we can compute these sums efficently. */}
...
{/* To find a modular inverse of some number modulo $p$, simply raise it to the
power of $p-2$. */}
