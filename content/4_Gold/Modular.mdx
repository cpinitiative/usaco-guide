...
author: Darren Yao, Michael Cao, Andi Qu, Benjamin Qi
prerequisites:
 - divis
description: '?'
frequency: 2
...
export const problems = {
	expo: [
		new Problem('CSES', 'Exponentiation', '1095', 'Easy', false, ['modular arithmetic'], '@Below'),
	],
	general: [
		new Problem('CSES', 'Exponentiation II', '1712', 'Easy', true, ['modular arithmetic'], ''),
		new Problem('CF', "Santa's Bot", 'contest/1279/problem/D', 'Easy', false, ['modular arithmetic'], ''),
	],
};
...
<Resources>
	...
	<Resource source="CF" title="Spheniscine - Modular Arithmetic for Beginners" url="https://codeforces.com/blog/entry/72527">some practice probs</Resource>
</Resources>
