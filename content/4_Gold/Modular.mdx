...
The [Chinese Remainder Theorem](https://en.wikipedia.org/wiki/Chinese_remainder_theorem) - also reffered to as CRT - yields an unique 
...
The above solution has exactly one solution modulo $M$.
...
modulo $m_1$, thus the properties hold: $n_1 \cdot m_1 \equiv 1 \pmod{m_2}$ and $n_2 \cdot m_2 \equiv 1 \pmod{m_1}$. 
