...
If you find yourself getting demotivated because you can't solve problems by
yourself, consider changing your goal to "how many problems can I solve per
week?" rather than "how often do I need to read the editorial to solve a
problem?" Your goal should be to solve as many problems as you can
:)<Asterisk>Of course, try not to give up too early</Asterisk>. On the flip
side, if you're able to solve most problems without the help of the editorial,
they're probably too easy for you, and you should try doing harder problems! For
more information, refer to the
[How to Practice](https://usaco.guide/general/practicing) module.

Best of luck on future contests!

If you have further questions, or don't understand a particular problem
solution, we encourage you to ask on the
[USACO Forum](https://forum.usaco.guide/).
