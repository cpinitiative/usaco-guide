...
[small-to-large merging](https://usaco.guide/plat/merging) and path compression 
to quickly perform union find. `sizes[x]` stores the size of each 
set, and `parents[x]` stores the representative of each set.
