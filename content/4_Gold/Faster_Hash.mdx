...
is easily hackable (see [neal's comment](https://codeforces.com/blog/entry/60737?#comment-454122)). To avoid this, we can replace `chash` with one of the custom hash functions mentioned [previously](../silver/unordered#another-hash-function).
...
You're supposed to use array since values are small. Note that initializing the initial capacity makes a significant difference in the runtime.
