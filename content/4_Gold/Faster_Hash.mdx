...
export const problems = {
	three: [
		new Problem('Gold', '3SUM', '994', 'Normal', false, ['Prefix Sums'], ''),
	],
	four: [
		new Problem(
			'CSES',
...
is easily hackable (see [neal's comment](https://codeforces.com/blog/entry/60737?#comment-454122)). To avoid this, we can replace `chash` with one of the custom hash functions mentioned [previously](/gold/unordered#another-hash-function).
...
<FocusProblem problem={problems.three[0]} />
