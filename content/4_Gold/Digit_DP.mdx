...
Code by
[Nathan Wang](https://github.com/thecodingwizard/competitive-programming/tree/master/USACO/2014open/silver).
...
// Find the number of interesting numbers between 1 and x
