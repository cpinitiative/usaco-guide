...
export const problems = {
	sample: [
		new Problem(
			'CF',
			'VK Cup Wildcard R1 C - Prime Factorization',
...
1095 Exponentiation -> NT 1712 Exponentiation II -> NT 1713 Counting Divisors -> NT 1081 Common Divisors -> NT 1082 Sum of Divisors -> NT 1079 Binomial Coefficients -> Combo 1715 Creating Strings II -> Combo
