...
export const problems = {
	sample: [
		new Problem(
			'CF',
			'Prime Factorization',
			'problemset/problem/162/C',
			'Very Easy',
			false,
			[]
		),
		new Problem('CSES', 'Counting Divisors', '1713', 'Easy', false, []),
	],
	kat: [new Problem('Kattis', 'Modular Arithmetic', 'modulararithmetic')],
	expo: [
		new Problem('CSES', 'Exponentiation', '1095', 'Easy', false, [], ''),
		new Problem('CSES', 'Exponentiation II', '1712', 'Normal', false, [], ''),
	],
	general: [
		new Problem(
			'AC',
...
<Problems problems={problems.expo} />
...
[**Fermat's Little Theorem**](https://en.wikipedia.org/wiki/Fermat%27s_little_theorem) (not to be confused with Fermat's **Last** Theorem) states that for any **prime number** $p$, all integers $a$ satisfy $a^{p - 1} \equiv 1 \pmod{p}$.

Consequently, $a^{p - 2} \cdot a \equiv 1 \pmod{p}$. Therefore, $a^{p - 2}$ is a modular inverse of $a$ modulo $p$.
