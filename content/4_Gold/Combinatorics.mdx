...
Here's the particular case for $n=3$ in which we have $C_4=$:

![polygons](./assets/catalan-polygons.png)

$C_n$ is also equal to the number of mountain ranges - see [Dyck words](https://en.wikipedia.org/wiki/Dyck_language) - of length $2n$ consisting of $n$ upstrokes and $n$ downstrokes.
