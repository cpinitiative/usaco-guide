...
Let's take a look at a particular example for $n=3$ and $k=2$ that has $4$ possibilities. As the name implies, the visualisation is usually done with stars 
...
non-empty. Thus, the answer is obtained by the first formula.
