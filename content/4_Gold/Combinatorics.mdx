...
<Resources>
	...
	>
		lots of pure math examples of expected value + explainations
	</Resource>
	<Resource
		source="Brilliant"
	...
	>
		lots of pure math examples of linearity of expectation + explainations
	</Resource>
...
To get our final answer, we put the expected values of all the indicator variables back together,
...
int main() {
    ...
    for (int i : reach_from) {
        expected_ops += 1.0 / (i + 1);
    }
