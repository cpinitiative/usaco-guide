...
The last testcase contains 100000 destinations and 149997 flights. City 1 has around 50000 flights to cities 2 through 50000. Cities 2 through 50000 have flights that go to city 50001. City 50001 has flights that go to cities 50002 through 100000. Without the `continue`, after the program pops off cities 1 through 50000, the priority queue will contain 49999 flights that point to city 50001. After getting the shortest cost to city 50001 from these flights, it will move on to the cities 50002 through 100000 that have flights from city 50001. This means that city 50001 will be processed 49998 more times than needed; furthermore, it carries over to the 49999 other flights from city 50001 to cities 50002-100000. This results in a worse runtime than $\Theta(N^2\log N)$, which will TLE. 

On the other hand, if we did include the `continue`, after setting the cost of city 50001, the program will pop off the other 49998 flights that do not have the shortest path without further adding their respective flights. Thus, it now only processes every city once. 
