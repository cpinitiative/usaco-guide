...
The last testcase contains 100000 destinations and 149997 flights. City 1 has around 50000 flights to cities 2 through 50000. Cities 2 through 50000 have flights that go to city 50001. City 50001 has flights that go to cities 50002 through 100000. Without the `continue`, after the program pops cities 1 through 50000 off the queue, the priority queue will contain 49999 routes that end at city 50001. After getting the shortest cost to city 50001 from these flights, it will move on to the cities 50002 through 100000 that have flights from city 50001. This means that city 50001 will be processed 49998 more times than needed (deleted the part but maybe i should rephrase it?). This results in a runtime of $\Theta(N^2\log N)$, which will TLE. 
