...
The last testcase contains 100000 destinations and 149997 routes. City 1 has around 50000 routes to cities 2 to 50000. Cities 2 to 50000 have routes that go to city 50001. City 50001 has routes that go to cities 50002 to 100000. Without the `continue`, after the program processes the routes from city 1, the priority queue will contain 49998 routes that point to city 50001. After getting the shortest route to city 50001 from these routes, it will move on to the cities 50002 to 100000 that can be reached from City 50001. However, the priority queue now has 49998 instances of these routes. This means that city 50001 will be processed 49998 more times and so on for the 49998 cities that branches out from city 50001. This results in a worse runtime than $\mathcal{O}(N^2)$, which will TLE. 
