...
export const problems = {
	...
	general: [
		...
		new Problem('Gold', 'Modern Art 2', '743', 'Normal', false, [], ''),
		new Problem('Gold', 'Dishwashing', '922', 'Normal', false, [], ''),
		new Problem('CSES', 'Maximum Building I', '1147', 'Normal', false, [], ''),
		new Problem(
			'IOI',
			'2004 - Empodia',
...
<Resources>
	<Resource source="CPH" title="4.5 - Stacks">brief description of operations</Resource>
	<Resource source="CSA" title="Stack Introduction" url="stack_introduction" starred>
...
A stack is a **Last In First Out** (LIFO) data structure that supports three operations, all in $O(1)$ time. Think of it like a real-world stack of papers.
...
<Resources>
	<Resource source="CPH" title="8.2 - Nearest Smaller Element" starred></Resource>
	<Resource
		source="CSA"
