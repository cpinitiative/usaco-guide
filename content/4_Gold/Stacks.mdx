...
export const problems = {
	...
	general: [
		...
		new Problem('CSES', 'Maximum Building I', '1147', 'Normal', false, [], 'cses-1147'),
		new Problem('CEOI', 'Fancy Fence', 'https://codeforces.com/contest/1402/problem/A', 'Normal', false, [], ''),
		new Problem(
			'IOI',
			'2004 - Empodia',
...
To solve this, let's store a stack of pairs of $value, index$ and iterate over the array from left to right. For some index $i$, we will compute $\texttt{ans}_i$, the rightmost index for $i$, as follows:
