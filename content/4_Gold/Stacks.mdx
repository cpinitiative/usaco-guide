...
export const problems = {
	...
	general: [
		...
		new Problem('Infoarena', 'ssdj', 'ssdj', 'Very Hard', false, [], ''),
		new Problem(
			'IOI',
			'2004 - Empodia',
...
<!-- new Problem('ojuz','IOI - Rectangles','IOI19_rect','Very Hard',false,[],'https://ioi2019.az/source/Tasks/Day1/Rect/review.pdf'), -->
