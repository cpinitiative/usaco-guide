...
```
	...
	<Quiz.Question>
		For which of the scenarios would a stack-based algorithm be most appropriate?
		<Quiz.Answer>
			Sorting a list of integers in ascending order
			<Quiz.Explanation>
				Sorting algorithms like QuickSort, MergeSort, or HeapSort are better for sorting integers.
			</Quiz.Explanation>
		</Quiz.Answer>
		<Quiz.Answer>
			Finding the shortest path in a weighted graph
			<Quiz.Explanation>
				Finding the shortest path usually involves algorithms that use priority queues or heaps, not stacks.
			</Quiz.Explanation>
		</Quiz.Answer>
		<Quiz.Answer>
			Searching for a value in an unordered list
			<Quiz.Explanation>
				Searching an unordered list is usually done using linear search algorithms.
			</Quiz.Explanation>
		</Quiz.Answer>
		<Quiz.Answer correct>
			Evaluating mathematical expressions with nested parentheses
			<Quiz.Explanation>
				Correct! A stack-based algorithm is best suited for this scenario because the Last In, First Out (LIFO) principle of stacks makes it easy to track opening parentheses and match them with closing parentheses.
			</Quiz.Explanation>
		</Quiz.Answer>
	</Quiz.Question>
