...
This problem previously appeared in [Intro to Trees](/silver/intro-tree/#problem-https://cses.fi/problemset/task/1132). This is simply an alternate solution to the problem. 
