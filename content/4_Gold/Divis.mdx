...
{/_ (See
[this Math Stack Exchange answer](https://math.stackexchange.com/questions/2477328/why-are-fibonacci-numbers-bad-for-euclids-algorithm-and-how-to-derive-this-uppe)
_/} {/_ ^ this doesn't seem very helpful _/} {/_ Since $F_n = O(\varphi^n)$, the
worst-case complexity of this algorithm is $\mathcal{O}(\log ab)$. _/}
