...
mat = [[int(1e18)] * n for _ in range(n)]
...
Due to the strict time limits, this Python code recieves a TLE verdict on two test cases.
...
dist[0] = 0  # The shortest path from a node to itself is 0
