...
Below is an implementation for factorization in $\mathcal{O}(\sqrt{n})$. It can be a little bit tricky to understand why we substract $ans/p$ from $ans$. For example
