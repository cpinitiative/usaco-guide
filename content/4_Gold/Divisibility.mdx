...
$a,b \le \frac{n}{d}$ guarantees us that $a \dot d, b \dot d \le n$ and $gcd(a \dot d, b \dot d) = d$, thus contributing to the global answer. Shifting away to our 
...
This way the global answer for a query is $\sum_{d=1}^{n}d \dot f(n, d) = \sum_{d=1}^{n}d \dot f(\frac{n}{d}, 1)$.
