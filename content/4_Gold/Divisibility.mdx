...
1. For each $k \leq 10^6$, find any prime number that divides $k$.
   ...
   [linear time](https://codeforces.com/blog/entry/54090), but we won't be needing it. The Sieve of Eratosthenes exploits the [harmonic trick](https://codeforces.com/blog/entry/118001).
