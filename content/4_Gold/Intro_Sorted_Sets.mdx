...
contributors: Aadit Ambadkar, Jeffrey Hu, Jason Sun, Raagav Bala
prerequisites:
  - intro-sets
...
Let the bit string be $s=s_0s_1s_2\dots,s_{n-1}$. In the set `dif`, we store
...
$$
\max(dif_2-dif_1,dif_3-dif_2,\dots,dif_k-dif_{k-1}).
$$
