...
fix one as the center node. Having precomputed the two groups of subsets (ingoing and outgoing), we want to find two sets that are disjoint, i.e no common element.
