...
Often, dynamic programming can be split into 4 steps: the base cases, the state, the recurrence, and the answer. 
...
The states of our dynamic programming are what each spot in our dp array/matrix represents. We want to set up the states such that the answer is one of the states, and there is a clear transition between states.
