...
{/_ Solutions for most of these problems can be found in Chapter 7 of CPH. _/}

### Problemsets

{/_ Dynamic Programming is a huge topic, so if you want more practice, _/}

{/_ Here are some other classical problemsets that we found interesting. _/}
...
{/_ Finish with some more challenging Dynamic Programming problems! _/}

{/_ Can be very difficult. _/}

{/_ You might want to try easier tasks in the next few modules first. _/}

{/_ so skip around if you want. _/}
