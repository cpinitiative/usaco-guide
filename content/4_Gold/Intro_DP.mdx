...
<Resources>
	...
	<Resource
		...
		url='https://github.com/ar492/DP-book/blob/main/Dynamic_Programming.pdf'
	/>
</Resources>
...
$\texttt{dp}[i]$ as the minimum cost to reach stone $i$. Then, our transitions are as follows:
...
$\texttt{dp}[1], \texttt{dp}[2], \dots \texttt{dp}[N - 1]$.
...
We can start with the base case that $\texttt{dp}[0] = 0$, since the frog is already on that square, and proceed to calculate $\texttt{dp}[1], \texttt{dp}[2], \dots \texttt{dp}[N - 1]$.
...
<Resources>
	...
	>
		...
		section. Editorials are available [here](https://codeforces.com/blog/entry/70018).
	</Resource>
	<Resource
		source="AC"
	...
	>
		Beginner-friendly classical problems. Some tasks require input/output
		files. Solution code can be found [here](https://github.com/nika-skybytska/Codeforces/tree/main/DynamicProgrammingC) and [here](https://github.com/Farrius/div3_dp_practice).
	</Resource>
	<Resource
		source="CF"
		title="DP Practice Problems"
		url="https://codeforces.com/blog/entry/67679">
		Good practice problems. You should be able to do most of these after completing the Gold DP module. Some problems might be beyond the scope of Gold.
	</Resource>
</Resources>
