...
You are **not** expected to complete all of the problems below before starting the other DP modules. In particular, we recommend that you begin with the [knapsack](/gold/knapsack) module if this is your first encounter with DP.
