...
export const problems = {
    ...
    usaco: [
      ...
      new Problem("CF", "Baltic OI - Village (Minimum)", "contest/1387/problem/B1", "Normal", false, [], ""),
      new Problem("Gold", "Delegation", "1019", "Hard", false, ["Greedy"], ""),
      new Problem("Plat", "Delegation", "1020", "Very Hard", false, ["DP", "Binary Search"], ""),
      new Problem("Plat", "Cow At Large", "793", "Insane", false, [], "usaco-793"),
      new Problem("CSES", "Creating Offices", "1752", "Insane", false, ["Greedy"], "equivalent to Baltic OI - Cat in a Tree. Exists a greedy-ish strategy!"),
    ],
}
