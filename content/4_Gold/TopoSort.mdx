...
<Resources>
	<Resource
		...
		starred
	>
		The algorithms to find a topological sort are based on BFS and DFS.
	</Resource>
...
<Resources>
	<Resource source="CPH" title="16.1, 16.2 - Topological Sorting">
		DFS
	</Resource>
	<Resource
		source="cp-algo"
...
vector<int> graph[100000]; // Assume that this graph is a DAG
bool visited[100000];
int idx = 0, top_sort[100000];
...
void compute() {
	...
	// The array `top_sort` is now topologically sorted
}
```
...
<Resources>
	<Resource source="PAPS" title="9.1">
		Best Path in a DAG
	</Resource>
</Resources>
