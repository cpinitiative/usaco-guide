...
{/_ <Resource source="PAPS" title="9.2 - Dynamic Programming"> Best Path in a
DAG </Resource> _/}
...
{/\* However, not all problems clearly give you directed acyclic graphs (ex.
[Plat - Cave Paintings](http://usaco.org/index.php?page=viewproblem2&cpid=996)).
An important step in many problems is to reduce the statement into a directed
acyclic graph. See the editorial of the linked problem for more information.
