...
export const problems = {
    ...
    diviSample: [
      new Problem("ojuz", "JOI Secret", "JOI14_secret", "Easy", false, [], "Since the secret operation is associative, we can store prefixes of queries and binary search for the values."),
    ],
    general: [
