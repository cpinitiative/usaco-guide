...
export const problems = {
	rmqSample: [
		new Problem(
			...
			false,
			[],
			'equivalent to [CSES Range Minimum Queries I](https://cses.fi/problemset/task/1647)'
		),
	],
	diviSample: [
		new Problem(
			...
			false,
			[],
			'http://s3-ap-northeast-1.amazonaws.com/data.cms.ioi-jp.org/open-2014/2014-open-d2-secret-review.pdf'
		),
	],
	general: [
		new Problem('CC', 'Product on Segment', 'SEGPROD', 'Hard', false, [], ''),
		new Problem(
			'DMOJ',
			'Continued Fractions',
			'dmopc19c7p4',
...
<Resources>
	<Resource source="CPH" title="9.1 - Minimum Queries" starred>
		diagrams
	</Resource>
