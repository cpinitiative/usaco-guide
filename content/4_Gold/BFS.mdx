	...
	<table className="text-center">
		<tbody>
			...
			<tr><td>Parent</td>
				...
				<td>1</td>
				<td>1</td>
				<td className="bg-green-200 dark:bg-green-800">4</td></tr>
			<tr><td>Distance</td>
				<td>0</td>
				<td>1</td>
				<td>1</td>
				<td>1</td>
				<td className="bg-green-200 dark:bg-green-800">2</td></tr>
		</tbody>
	</table>
</center>
...
{/* Sometimes, when a Dijkstra runs too slowly, you need to use a 0/1 BFS
instead. */}
