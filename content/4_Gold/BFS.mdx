...
Finally, we can backtrack from node $n \rightarrow 1$, in this case $5 \rightarrow 1$. This looks like $5 \rightarrow 2 \rightarrow 1$. We break here because we notice that the parent of node $1$ is 0.
