...
export const problems = {
    ...
    usacoPast: [
      new Problem("Gold", "Circular Barn Revisited", "622", "Normal", true, ["DP", "Brute Force"], "brute force starting location, then do dp[first i positions][number of doors used][position of last door] ->  minimum distance cows need to travel", "http://www.usaco.org/current/data/sol_cbarn2_gold_feb16.html"),
      ...
      new Problem("Plat", "Team Building", "673", "Hard", false, [], "", "http://www.usaco.org/current/data/sol_team_platinum_dec16.html"),
