...
This post also explains how to hash rooted trees - an uncommon technique, but still useful to know!
...
However, note that using two bases with the same modulo works too.
