...
export const problems = {
    ...
    general: [
      ...
      new Problem("CF", "Palindromic Characteristics", "contest/835/problem/D", "Easy", false, ["DP", "Hashing"], ""),
      new Problem("Gold", "Lights Out", "599", "Normal", false, [], "oops you don't actually need hashing to pass ..."),
      new Problem("CF", "Liar", "contest/822/problem/E", "Hard", false, ["DP", "Hashing"], ""),
...
<Resources>
  <Resource source="Benq" url="https://github.com/bqi343/USACO/blob/master/Implementations/content/strings%20(14)/Light/HashRange%20(14.2).h" title="HashRange"> </Resource>
</Resources>
