...
<thead>
  <tr>
    ...
    <th className="tg-i1q2">x</th>
    <th className="tg-i1q2">a</th>
    <th className="tg-i1q2">b</th>
    <th className="tg-i1q2">c</th>
    <th className="tg-i1q2">d</th>
  </tr>
</thead>
<tbody>
  <tr>
    <td className="tg-smvl">y</td>
    <td className="tg-elvq">0</td>
  ...
  <tr>
    <td className="tg-smvl">a</td>
    <td className="tg-0pky">0</td>
    <td className="tg-1i2r">1</td>
    <td className="tg-elvq">1</td>
    <td className="tg-0pky">1</td>
    <td className="tg-0pky">1</td>
  </tr>
  <tr>
    <td className="tg-smvl">z</td>
    <td className="tg-0pky">0</td>
    <td className="tg-0pky">1</td>
    <td className="tg-elvq">1</td>
    <td className="tg-0pky">1</td>
  ...
  <tr>
    <td className="tg-smvl">c</td>
    <td className="tg-0pky">0</td>
    <td className="tg-0pky">1</td>
    <td className="tg-0pky">1</td>
    <td className="tg-1i2r">2</td>
    <td className="tg-elvq">2</td>
  </tr>
</tbody>
</table>
