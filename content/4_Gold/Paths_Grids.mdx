...
{/_ ### Paths in a Grid (and related) _/}

{/_ Interesting applications of "number of paths on a grid," some of which don't
directly present a grid in the problem, but can be modelled as one. _/} {/_
Asterisk> Such as Longest Common Subsequence. </Asterisk> _/}
