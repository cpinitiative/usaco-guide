...
{/* In particular those that involve making GCD equal to $1$, may be optimized
using a sort of bitmask over primes. */}
...
{/* Operating like this makes it easier to think about and apply PIE or SOS wrt
numbers and GCDs. */}
