...
- Otherwise, the point $P_i$ lies on the right side of the segment $P_{i-1}P_k$. In this case, we can process the next point $P_{k+1}$ from the given point list. 
