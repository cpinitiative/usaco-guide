...
export const problems = {
    ...
    comb: [
      ...
      new Problem("POI", "Cards", "https://szkopul.edu.pl/problemset/problem/qpsk3ygf8MU7D_1Es0oc_xd8/site/?key=statement", "Normal", false, [], ""),
      new Problem("Plat", "High Card Low Card", "577", "Normal", false, ["PURQ", "Greedy"], ""),
    ],
    waveletSam: [
      new Problem("YS", "Range K-th Smallest", "range_kth_smallest", "Normal", false, ["Wavelet"], ""),
    ],
    wavelet: [
      new Problem("Kattis", "Easy Query", "easyquery", "Hard", false, ["Wavelet"], "easy-query"),
