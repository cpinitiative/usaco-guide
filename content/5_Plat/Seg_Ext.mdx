...
export const problems = {
	...
	comb: [
		new Problem('CSES', 'Pizzeria Queries', '2206', 'Easy', false, [], 'cses-2206'),
...
<Resources>
	<Resource source="CF" title="EDU: Segment Tree Pt 1 Step 2" url="https://codeforces.com/edu/course/2/lesson/4/1" starred>both of these topics</Resource>
	<Resource
		source="cp-algo"
...
<FocusProblem problem={problems.walkSam[0]} />
...
<FocusProblem problem={problems.combSam[0]} />

<FocusProblem problem={problems.combSam[1]} />

### Solution - Point Set Range Composite

The segment tree from the prerequisite module should suffice. You can also use two BITs as described [here](https://ioinformatics.org/journal/v9_2015_39_44.pdf), although it's more complicated.
