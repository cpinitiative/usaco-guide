...
export const problems = {
    ...
    bit: [
      ...
      new Problem("IOI", "Pairs", "https://oj.uz/problem/view/IOI07_pairs", "Normal", false, ["3D BIT"], "https://ioinformatics.org/files/ioi2007solutions.pdf"),
    ],
    offSam: [
    ...
    seg: [
      new Problem("POI", "Tetris 3D", "https://szkopul.edu.pl/problemset/problem/OQjANSOOD_-c38gh8p6g3Gxp/site/?key=statement", "Hard", false, ["2D Seg"], "https://github.com/mostafa-saad/MyCompetitiveProgramming/blob/master/Olympiad/POI/official/2006/editorial/tet.pdf"),
