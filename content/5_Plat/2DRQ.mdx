...
export const problems = {
    bitSam: [
      new Problem("CSES", "Forest Queries II", "1739", "Easy", false, ["2D BIT"], "Just implement a 2D BIT. See [thecodingwizard's implementation](https://github.com/thecodingwizard/competitive-programming/blob/master/cses/Forest%20Queries%20II.cpp)."),
    ],
    bit: [
      new Problem("DMOJ", "Crowded Cities", "bfs17p6", "Normal", false, ["2D Max BIT"], ""),
      new Problem("IOI", "Pairs", "https://oj.uz/problem/view/IOI07_pairs", "Normal", false, ["3D BIT"], "1D: Sort everything and binary search for the leftmost animal each animal can hear. 2D: Rotate everything by 45 degrees and use a 2D BIT. 3D: Extend the 2D solution to use a 3D BIT."),
    ],
    offSam: [
    ...
    seg: [
      ...
      new Problem("ojuz", "IOI 2013 - Game", "IOI13_game", "Very Hard", false, ["2D Seg"], "A normal 2D sparse segment tree gets MLE, so we have to use a sparse segment tree of BBSTs (see Advanced - Treaps)."),
      new Problem("ojuz", "JOI - Golf", "JOI17_golf", "Very Hard", false, ["Seg"], "http://s3-ap-northeast-1.amazonaws.com/data.cms.ioi-jp.org/open-2017/2017-open-golf-sol-en.pdf"),
    ],
};
