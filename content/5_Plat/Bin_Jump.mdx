...
<Resources>
	<Resource source="CPH" title="18.3 - LCA Method 1">brief description</Resource>
	<Resource
		source="Benq"
		title="LCAjump"
...
As mentioned in the [Euler Tour Technique](/gold/tree-euler) module, let $\texttt{st}, \texttt{en}, \texttt{up}$ be the time-in, time-out, and ancestor table for all nodes in the tree.
