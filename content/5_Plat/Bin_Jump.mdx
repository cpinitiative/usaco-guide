...
export const problems = {
    ...
    general: [
      ...
      new Problem("CF", "Lynyrd Skynyrd", "/contest/1142/problem/B", "Easy", false, ["BinJump"], ""),
      ...
      new Problem("TLX", "Functional Constraint", "https://tlx.toki.id/contests/troc-12-div-1/problems/D", "Hard", false, ["LCA"], ""),
      new Problem("TLX", "Graph & Destination", "https://tlx.toki.id/contests/troc-13-div-1/problems/E", "Hard", false, ["LCA"], ""),
      ...
      new Problem("Plat", "Exercise", "901", "Very Hard", false, ["LCA"], "The answer is the number of pairs of paths that overlap. If we split each path A-B into the 2 paths A-lca(A, B) and B-lca(A, B), then we can count how many pairs of those paths overlap and subtract the number of pairs of paths that have the same lca and 2 outgoing edges from the lca. The case where the tree is a line is a classical problem and we can adapt it to work on a general tree."),
    ]
};
