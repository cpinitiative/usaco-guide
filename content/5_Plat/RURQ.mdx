...
export const problems = {
    ...
    lazySegTree: [
      ...
      new Problem("ojuz", "JOI - Bubble Sort 2", "JOI18_bubblesort2", "Hard", false, ["Lazy SegTree"], "http://s3-ap-northeast-1.amazonaws.com/data.cms.ioi-jp.org/open-2018/2018-open-bubblesort2-sol-en.pdf"),
    ],
    lazySegCnt: [
