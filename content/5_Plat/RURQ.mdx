...
-	Range add $lzAdd$ when $lzSet$ doesn't equal 0: Add the new value to $lzSet$ and clear $lzAdd$. 

-	Range set when $lzAdd$ equals 0: Simply update the $lzSet$ value. 

-	Range set when $lzAdd$ doesn't equal 0: Again simply update the $lzSet$ value since a set update will override all previous add update. 
