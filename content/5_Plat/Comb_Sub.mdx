...
export const problems = {
  sam: [
    new Problem("CF", "Karen & Supermarket", "contest/815/problem/C", "Normal", false, [], ""),
  ],
  gen: [
    new Problem("ojuz", "COCI - Dzumbus", "COCI19_dzumbus", "Normal", false, [], "coci-dzum"),
    new Problem("CF", "Div 1 D - Miss Punyverse", "contest/1280/problem/D", "Normal", false, [], ""),
    new Problem("DMOJ", "IOI - Rivers", "ioi05p6", "Normal", false, [], "ioi-rivers"),
    new Problem("CF", "Ostap & Tree", "problemset/problem/735/E", "Normal", false, ["DP"], "ostap-tree"),
    new Problem("DMOJ", "COCI - Periodni", "coci08c4p6", "Hard", false, ["NT"], "coci-period"),
  ],
}
