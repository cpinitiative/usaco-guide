...
export const problems = {
  ...
  gen: [
    new Problem("ojuz", "COCI - Dzumbus", "COCI19_dzumbus", "Normal", false, [], ""),
    new Problem("CF", "Div 1 D - Miss Punyverse", "contest/1280/problem/D", "Normal", false, [], ""),
    new Problem("DMOJ", "IOI - Rivers", "ioi05p6", "Hard", false, [], "ioi-rivers"),
    new Problem("CF", "Ostap & Tree", "problemset/problem/735/E", "Hard", false, ["DP"], "ostap-tree"),
  ],
}
