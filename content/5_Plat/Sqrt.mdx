...
export const problems = {
	...
	bad: [
		...
		new Problem('Plat', 'New Barns', '817', 'Hard', false, [], ''),
		new Problem(
			'CF',
			'Tree Queries',
		...
		new Problem('CSA', 'Shopping Time', 'shopping-time', 'Hard', false, [], ''),
		new Problem(
			'Old Gold',
			'Fencing the Herd',
			'534',
...
<Resources>
	...
	<Resource source="CF" title="Applications of Square Root Decomposition" url="https://codeforces.com/blog/entry/83248" starred>Blocking, Mo's Algo</Resource>
</Resources>
...
<Resources>
	<Resource source="CF" title="Mo's Algorithm" url="7383"><i>very</i> brief description</Resource>
</Resources>
