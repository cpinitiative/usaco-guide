...
export const problems = {
	dnc_sample: [
		new Problem('Plat', 'Circular Barn', '626', 'Hard', false, [], ''),
	],
	dnc_general: [
		new Problem('CEOI', 'Two Sawmills', 'https://szkopul.edu.pl/problemset/problem/ovRIpLFK3IhyFPjnVXeZtGxH/site/?key=statement', 'Normal', false, [], ''),
		new Problem(
			'CF',
			'Ciel and Gondolas',
			'321/problem/E',
		...
		new Problem('CF', 'Yet Another Minimization Problem', '868/problem/F', 'Hard', false, [], ''),
		new Problem(
			'POI',
			'2014 - Solar Lamps',
		...
		new Problem('IOI', 'Holiday', 'IOI14_holiday', 'Very Hard', true, [], ''),
		new Problem('Plat', 'Mowing Mischief', '926', 'Very Hard', false, [], ''),
		new Problem(
			'JOI',
			'Bubblesort',
...
Allows you to reduce $O(N^2)$ to $O(N\log N)$.
