...
export const problems = {
    ...
    general: [
      new Problem("CSES", "Baltic OI - Olympiads", "https://cses.fi/248/list/", "Normal", false, [], "First, construct the best team as the base state. Each state has at most K children. Since the bounds are small, we can just keep a priority queue of the current states and brute force."),
