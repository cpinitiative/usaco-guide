...
export const problems = {
	...
	general: [
		...
		new Problem(
			...
			false,
			['Slope Trick', 'Small to Large'],
			'ICPC world finals, 0 solves in contest - "Potatoes" on tree!!'
		),
	],
};
...
<Resources>
	<Resource source="CF" title="zscoder - Slope Trick" url="blog/entry/47821">
		3 problems using this trick
	</Resource>
	<Resource
		source="CF"
		title="Kuroni - Slope Trick Explained"
		url="blog/entry/77298"
	>
