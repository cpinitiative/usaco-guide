...
Below, the purple line represents the DP values where we can choose to sell two shares. The black line represents the option of selling one share, and the red line represents not being to sell any shares at all.
