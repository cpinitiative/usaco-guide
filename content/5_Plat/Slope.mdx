...
export const problems = {
    ...
    buy: [
      new Problem("CF", "Buy Low Sell High", "contest/866/problem/D", "Easy", false, ["Slope Trick"], "@B"),
    ],
    potatoes: [
      new Problem("ojuz", "LMIO - Potatoes & Fertilizers", "LMIO19_bulves", "Normal", false, ["Slope Trick"], "@B"),
    ],
    landscaping: [
    ...
    general: [
	  ...
	  new Problem("ojuz", "CEOI - Magic Tree", "CEOI19_magictree", "Normal", false, ["Slope Trick"], ""),
	  new Problem("ojuz", "NOI.sg - Safety", "NOI18_safety", "Hard", true, ["Slope Trick"], ""),
      ...
      new Problem("ojuz", "APIO - Fireworks", "APIO16_fireworks", "Hard", true, ["Slope Trick", "Small to Large"], ""),
