...
export const problems = {
	...
	general: [
		...
		new Problem(
			...
			'Looks like $O(N log^3 N)$ is very fast! When deleting an edge, remember how many systems that edge was used to synchronize. Also, each moment there is a connected component, all computers in the component have the same value.'
		),
		new Problem(
			'CF',
			'Raining Season',
			'contest/1019/problem/E',
			'Very Hard',
			false,
			['Centroid', 'CHT', 'Set Merging'],
...
_Note:_ Unfortunately, it seems like constant factor is especially important for DMOJ. :|
