...
**Centroid Decomposition** is a divide and conquer technique for trees. The
**centroid** of a tree is a node which, if rooted, results in no other nodes
having a subtree of size greater than $\frac{N}{2}$. **Centroid Decomposition**
