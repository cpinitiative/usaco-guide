...
export const problems = {
    ...
    general: [
        ...
        new Problem("CF", "BOI - Village (Maximum)", "contest/1387/problem/B2", "Easy", true, ["Centroid"], "First, find one of the centroids in the tree and split the tree into 2 subtrees X and Y, where X is the smaller subtree and Y is rooted at the centroid. All citizens in X must move to Y and all citizens from the largest subtree of the centroid's children must move to X (otherwise the centroid isn't a centroid). Then just shift the remaining citizens arbitrarily."),
