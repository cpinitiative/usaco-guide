...
{/* pulled from https://codeforces.com/contest/1303/submission/76216413, which I
think is my most recent centroid problem */}
...
{/* Modified from above. I can't guarauntee it compiles and functions as
expected */}
...
{/* Note: Unfortunately, it seems like constant factor is especially important
for DMOJ. */}
