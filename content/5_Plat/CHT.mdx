...
export const problems = {
	...
	general: [
		...
		new Problem(
			...
			false,
			['DP', 'convex'],
			'CHT on a tree -- dfs on the tree and keep track of which lines you remove so you can "restore" the deque of lines when leaving a node. Editorial: https://infosb.net/ceoi2009/tasks/solutions.doc'
		),
		new Problem(
			'IOI',
