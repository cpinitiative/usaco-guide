...
export const problems = {
    ...
    general: [
      new Problem("ojuz", "BOI - Postmen", "BOI14_postmen", "Easy", false, ["Euler Tour"], "We know that an Eulerian cycle of this graph exists. An Eulerian cycle can be split into several disjoint cycles and we do so greedily."),
