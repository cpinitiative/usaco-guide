...
export const problems = {
    ...
    probs: [
      ...
      new Problem("ojuz", "Aliens", "IOI16_aliens", "Hard", false, [], "https://ioinformatics.org/files/ioi2016solutions.pdf"),
    ]
};
...
<Resources>
  ...
  <Resource source="Serbanology" title="The Trick from Aliens" url="http://serbanology.com/show_article.php?art=The%20Trick%20From%20Aliens"></Resource>
</Resources>
