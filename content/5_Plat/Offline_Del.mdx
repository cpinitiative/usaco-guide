...
<Resources>
	<Resource source="GCP" title="15.5.4 - Dynamic Connectivity"> </Resource>
</Resources>
...
Because path compression is amortized, it does not guarauntee $O(N \log^2 N)$ runtime. You _must_ use merging by rank.
