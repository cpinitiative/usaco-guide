...
export const problems = {
    ...
    res: [
      ...
      new Problem("CF", "Baltic OI - Joker", "contest/1386/problem/C", "Very Hard", false, ["D&C", "DSUrb"], ""),
    ]
};
...
Because path compression is amortized, it does not guarauntee $O(N \log^2 N)$ runtime. You *must* use merging by rank.
