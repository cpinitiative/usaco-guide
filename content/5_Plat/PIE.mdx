...
<Warning title="TLE">
The solution results in TLE for some test cases because of python's constant factor.
</Warning>
...
sys.stdin = open("cowpatibility.in", "r")
sys.stdout = open("cowpatibility.out", "w")
