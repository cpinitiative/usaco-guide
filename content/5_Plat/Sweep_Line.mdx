...
<FocusProblem problem="restaurant" />

### Solution
**Time Complexity:** $\mathcal{O}(N\log N)$

The solution uses a sweep line approach. Each interval is converted into two events: $(a_i, +1)$ for an arrival and $(b_i, -1)$ for a departure. This produces $2N$ events in total.  

<!--- https://i.imgur.com/a/4PGI16s -->
...
$(2,+1), (3,+1), (4,-1), (5,+1), (8,-1), (9,-1)$ with counters $1,2,1,2,1,0$. The maximum is $2$.

Creating events takes $\mathcal{O}(N)$, sorting them takes $\mathcal{O}(N \log N)$, and the sweep is $\mathcal{O}(N)$. Thus the overall complexity is $\mathcal{O}(N \log N)$.
