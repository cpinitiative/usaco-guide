...
export const problems = {
    sam2: [
      new Problem("YS", "Two-Edge-Connected Components", "two_edge_connected_components", "Easy", false, [], "Split the graph into its biconnected components. See Infoarena - Biconex for how to do this."),
    ],
    disrupt: [
...
<Resources>
  ...
  <Resource source="Infoarena" title="Infoarena - Biconex" url="https://infoarena.ro/problema/biconex"> </Resource>
</Resources>
