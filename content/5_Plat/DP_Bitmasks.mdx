...
Let our dp states be defined as $dp[S][i]$ being the amount of routes that visit all the cities in the subset $S$ and end at city $i$. The transitions will then be:
$$
