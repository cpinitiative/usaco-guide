...
Below is an example implementation of Heavy Light Decomposition. See the solution below, as well as the internal solutions for __ and __, for examples of how this implementation can be used.
