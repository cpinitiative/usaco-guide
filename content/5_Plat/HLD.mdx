...
Below is an example implementation of Heavy Light Decomposition based on the resources above. See the solution below, as well as the internal solutions for [Subtrees & Paths from HR](problems/hr-subtrees-paths/solution) and __, for examples of how this implementation can be used.
