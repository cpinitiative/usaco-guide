...
Heavy Light Decomposition (or HLD) is needed to support both operations efficiently.

### Definitions

To begin, here are some important definitions required to understand HLD:
