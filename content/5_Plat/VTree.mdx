...
Sometimes we can't completely ignore the contribution of nodes outside our virtual tree.

<FocusProblem problem="ctt" />
...
Our time complexity will be $\mathcal{O}(n\log n)$, for constructing the virtual trees.
