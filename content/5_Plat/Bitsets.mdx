...
Operations such as `_Find_first()` and `_Find_next()` mentioned in Errichto's blog are helpful.
...
In USACO Camp, a similar problem appeared with $N\le 10^5$ and a $6$ second time limit. Try to guess what I did!
