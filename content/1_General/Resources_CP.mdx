...
- [Competitive Programmer's Handbook](https://cses.fi/book/book.pdf) (CPH) - Antti Laaksonen
  - The [CSES problemset](https://cses.fi/problemset/) (now at 300 problems) is quite good!
    - No official tutorials, but the following links might be helpful if you're stuck.
    - [List of Unofficial Tutorials](https://codeforces.com/blog/entry/80750?#comment-670697)
    - [200+ Solutions in C++ (superj6)](https://github.com/superj6/CPcode/tree/master/c%2B%2B%20sol/CSES)
  - [Guide to Competitive Programming](https://www.springer.com/us/book/9783030393564) is a paid book based off CPH.
