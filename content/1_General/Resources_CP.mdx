...
- Competitive Programming Book - Steven Halim, Felix Halim
  ...
  - [Competitive Programming 3](https://github.com/prasadgujar/CompetitiveProgramming/blob/master/book/Competitive%20Programming%203.pdf)
    is also freely available but also somewhat old (2013).
