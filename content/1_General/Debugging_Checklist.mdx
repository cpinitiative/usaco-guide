...
Debugging](/general/basic-debugging) [Debugging C++](/general/debugging-cpp) 
...
- [Shadowed](https://en.wikipedia.org/wiki/Variable_shadowing#C++) or unused or
  ...
  - (C++) Compiling with
    [warning options](/general/debugging-cpp#warning-options)
...
- Any _undefined behavior_? It can result in different outputs locally vs online
  ...
  In C++, compiling with
  [additional options](/general/debugging-cpp#debug-options) can help catch
  these.
