...
- [ide.thecodingwizard.me](https://ide.thecodingwizard.me/)
  ...
  - note that the number of submissions is limited, so please don't excessively spam the "Run" button...
  - can be unstable at times; if it starts acting weird, make a new file
- [ide.judge0.com](https://ide.judge0.com/)
  - Basically ide.thecodingwizard.me except without real-time collaboration
  - More stable; if you don't need real-time collaboration use this over ide.thecodingwizard.me
...
If you installed GCC as described in [Further Instructions](/general/running-code/#further-instructions), then you should be good to go.
