...
<Resources>
	...
	<Resource
		source="Philippines OI"
		title="Prepare"
		url="https://noi.ph/prepare/"
		starred
	>
		lots of links!
	</Resource>
	...
	>
		generally good, although CSES problemset (see "Resources") is definitely a
...
Some modules in the "General" section (ex. Fast Input & Output) are not relevant for USACO Bronze contestants. It is probably best to skip these for now and return to these later. <!-- However, make sure to check [Code Conventions](code-con) for the templates that will be used for code snippets in later modules!
 -->
