...
{/* The following problems require relatively little programming experience and
...
{/* However, make sure to check [Code Conventions](/general/code-con) for the
templates that will be used for code snippets in later modules! */}
