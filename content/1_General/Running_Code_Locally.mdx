...
<Resources>
	<Resource
		...
		starred
	>
		See [PAPS 2.1](https://www.csc.kth.se/~jsannemo/slask/main.pdf#page=30) and the [docs](https://code.visualstudio.com/docs/cpp/config-linux) for C++ setup instructions.
	</Resource>
	<Resource
		source="Jetbrains"
		title="CLion"
