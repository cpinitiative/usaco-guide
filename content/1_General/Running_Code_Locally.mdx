...
These keybinds are all documented in the cheat sheet, linked above. Additionally, you can run the `vimtutor` command in terminal, opening a tutor that can help you learn the keybinds.
