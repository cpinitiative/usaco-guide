...
{/_ These often have C++ support already built-in. _/}
...
{/_ <Resource
	...
	> Windows. Heavier cousin of Visual Studio Code (which is better for competitive
programming). </Resource> <Resource
		source="Eclipse"
		title="C/C++ IDE"
