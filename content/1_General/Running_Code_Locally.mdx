...
but you are not able to edit any text. In order to edit text,
enter insert mode. You can enter insert mode with `i` (insert
before cursor), `a` (insert after cursor), among others. To return
to normal mode when in insert mode, press `Esc`.
