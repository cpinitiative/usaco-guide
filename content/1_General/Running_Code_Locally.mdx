...
These keybinds are all documented in the cheat sheet, linked above. Additionally, you can run the `vimtutor` command in terminal to open a tutor that can help you learn the vim keybinds.
