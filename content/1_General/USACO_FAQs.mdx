...
evaluated and scored against a set of predetermined test cases.
There are four divisions of contests: Bronze, Silver,
...
$1000/3 = 333.333 \dots$ points. All test cases for a problem (typically 10-30) are weighted
equally, except the sample test case(s), which are worth zero points.<Asterisk>In older contests, sample test cases counted toward your score.</Asterisk> For example, [Cow College](http://www.usaco.org/index.php?page=viewproblem2&cpid=1251) has 1 sample test case (test case 1) and 11 non-sample test cases (test cases 2-12). For each of test cases 2-12 you get correct, you earn
...
Once you know how to submit a solution to a USACO problem (described in [this module](/general/input-output)), you can solve the following problem to check your understanding:
...
## Q: When should I read the USACO analyses (official solutions)?
