...
## Q: I'm not receiving an email after registering on [usaco.org](http://www.usaco.org/). Who do I ask for help?
...
**Do not** submit to the USACO Guide contact form, as the USACO Guide is not 
affiliated with the USACO.
