...
| ----------- | ----------------------- | ----------------------- | ------------------------ | -------------------------- | ---------------- | 
| Description | 32-bit integer          | 64-bit integer          | Double-precision float     | True/False value | 8-bit character                  | String         | Arbitrary-size integer |
| Size (bits) | 32                      | 64                      | 32                       | 64                         | 1(\*)            | 16                               |
| Range       | $-2^{32}$ to $2^{32}-1$ | $-2^{64}$ to $2^{64}-1$ | `-1.7E+308` to `+1.7E+308` | true/false       | `\u0000` to `\uffff` ($0-65535$) |
