...
- `-O2` tells `g++` to compile your code to run more quickly (see [here](https://www.rapidtables.com/code/linux/gcc/gcc-o.html)). Note that `-O2` will increase compilation time. Think of it as a trade-off between runtime and compile time. 
