...
author: Many
contributors:
  Vihaan Anand, Benjamin Qi, Hankai Zhang, Anthony Wang, Nathan Wang, Nathan Chen, Michael
  Lan, Arpan Banerjee
description:
...
<Resources>
	...
	<Resource
		source="Ubuntu.com"
		title="The command line for beginners"
...
- `-Wall` checks your program for common errors. See
  [Debugging](/general/debugging-cpp/#gcc-warning-options) for more information.
