...
See [Input & Output](/general/io) for how to do file input and output within the
program.
...
Note that USACO does not have a stack size limit, aside from the usual 256 MB memory limit. See [this discussion of the stack size](https://forum.usaco.guide/t/floodfill-2016-january-silver-problem-3/1005/5) for more information.
