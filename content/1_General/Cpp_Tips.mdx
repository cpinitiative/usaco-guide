...
Definitely works on CF and DMOJ. As mentioned above, may cause runtime errors on some sites (ex. [Szkopuł](https://szkopul.edu.pl/)). I don't believe that these work for USACO. It's also unclear to me whether additional pragmas (ex. `#pragma GCC optimize("unroll-loops")`) actually make a difference in contest.
