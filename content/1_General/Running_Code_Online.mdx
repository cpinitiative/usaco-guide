...
{/* If you use Ideone during an online contest (such as a Codeforces round), you
...
if you never intentionally provide the code to anyone.** */}

{/* Even if you are not doing an online contest, you might want to set your code
to be private for other reasons. */}
