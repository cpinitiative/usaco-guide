...
<Resources>
	...
	<Resource title="Joshua Pan - Schedule for Beginners"
...
<Resources>
	...
	<Resource source="LCPP" title="Learn C++" url="https://www.learncpp.com/">
		detailed instructions for Visual Studio Community (Windows) and Code::Blocks
		(Windows, Linux)
	</Resource>
	<Resource source="CPP" title="C++ Language Tutorial" url="http://www.cplusplus.com/doc/tutorial/">
	</Resource>
</Resources>
