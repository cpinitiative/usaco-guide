...
Language references: [C++](https://en.cppreference.com/w/), [Java](https://docs.oracle.com/javase/8/docs/api/overview-summary.html), [Python 3](https://docs.python.org/3/reference/).
