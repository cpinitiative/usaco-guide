...
## Should I use C++ over C++11 or Python 2 or Python 3?

There probably isn't any disadvantage to just going with the newer versions (so C++11, Python 3).

 - [Python 2 vs Python 3](https://www.geeksforgeeks.org/important-differences-between-python-2-x-and-python-3-x-with-examples/)
 - [C++11](https://codeforces.com/blog/entry/10124)
