...
Please follow these code conventions when contributing a solution to USACO Guide:

- Try to use descriptive variable names.
- Use `snake_case` for Python.
- Do not name a data structure the data structure's name.
- If you use a I/O template, make sure to collapse it with `CodeSnips`.
  - Start your `CodeSnip` with `//BeginCodeSnip{I/O Template}`.
  - End your `CodeSnip` with `//EndCodeSnip`.
  - For Java code, please do not use `Scanner`.
