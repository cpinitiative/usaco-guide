...
We assume that you know how to code in one of the languages listed above. For a more detailed list on what you should know, read the [Expected Knowledge module](/general/expected).
