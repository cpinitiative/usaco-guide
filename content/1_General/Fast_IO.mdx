...
~10.3MB large), though not output files (the largest I recall is due to
...
- Including the second line will reduce the runtime in the case where you
  interleave `cin` and `cout` (as is the case in the task at hand).
...
<Spoiler title="cin/cout + magic lines + endl (5.0s)">
...
<Spoiler title="freopen + cin/cout + magic lines + \n (0.42s)">
