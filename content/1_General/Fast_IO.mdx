...
As [`Kattio`](/general/io?lang=java#io-template) is just a wrapper around
...
{/_ The most realistic input method to implement in contest is `BufferedReader`,
as it is relatively fast for the amount of code necessary. _/}
