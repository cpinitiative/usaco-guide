...
If you're not familiar with any of the features used in the code below, check [Writing Generic Code](/general/generic) and [C++ Tips & Tricks](/general/cpp-tips) for more information.
