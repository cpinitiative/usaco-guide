...
A normal Java template will contain a main method, helpful imports, and some form of I/O. See `Kattio` from the [I/O module](https://usaco.guide/general/io#java) for an example.
