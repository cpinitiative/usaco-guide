...
export const problems = {
	general: [
		new Problem('Kattis', 'Basketball One on One', 'https://open.kattis.com/contests/mcpc19open/problems/basketballoneonone', 'Very Easy'),
	],
};
...
Here is a task similar to the one that was mentioned in Kamil's video:
