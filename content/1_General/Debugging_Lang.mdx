...
If you use this script, please make sure you have Java installed onto your computer by following the steps [here](https://usaco.guide/general/running-code-locally?lang=java#installation).
