...
Here is an script to test a Java program with input and output files. You will need to put the `.java`, this script, and the `1.in`, `1.out` files in the same directory:
