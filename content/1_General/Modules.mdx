...
Example input / output will be provided if not already contained within the statement of the standard problem. See [Code Conventions](code-con) for more information regarding what our code will look like.
