...
### Conventions for Problem Sources and Tags
 ...
 - Some sources are automatically assigned [tooltips](https://github.com/cpinitiative/usaco-guide/blob/master/src/models/problem.ts) that display when hovered on.
 For sources not automatically assigned a tooltip, you can give it one by specifying the source as `source@tooltip`.
