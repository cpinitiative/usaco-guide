...
<Resources>
	...
	<Resource source="PAPS1" title="2.3 - Input and Output">
		cin, getline
	</Resource>
</Resources>
...
We assume in this section that you are using an [online IDE](/general/running-code-online), such as the
[USACO Guide IDE](https://ide.usaco.guide/). The instructions for using
a [local IDE](/general/running-code-locally) are similar, except you skip the download step.
...
![bad](/content/1_General/Error.png)
