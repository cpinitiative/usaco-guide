...
`PrintWriter` and takes care of the string processing for you. This is
essentially equivalent to method 2 above, so whether you prefer to use this over
method 2 is just a matter of personal preference.
