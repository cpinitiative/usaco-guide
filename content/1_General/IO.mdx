...
USACO prohibits prewritten code but allow you to consult resources about basic functionality such as input / output. So feel free to refer to this module (but not to copy paste from it) during a USACO contest.
