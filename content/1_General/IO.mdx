...
{/* We use `using namespace std;` so that we don't have to preface standard
library functions with `std::` each time we use them. */}
...
{/* **Note:** If you went through the recommended sections of Sololearn from
[Choosing a Language](/general/choosing-lang#resources-for-learning-how-to-code),
then you should be able to implement this yourself. */}
