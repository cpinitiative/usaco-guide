...
USACO contests prohibit prewritten code but allow you to consult resources about basic functionality such as input / output. In other words, feel free to refer to this module (but not to copy paste from it) during a USACO contest.
