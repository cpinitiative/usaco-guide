...
2.  If it doesn't already exist, create a new `mdx` file in `solutions/<division>/`
    including frontmatter, e.g. the following in
    [`solutions/silver/usaco-690.mdx`](https://github.com/cpinitiative/usaco-guide/blob/master/solutions/silver/usaco-690.mdx):
