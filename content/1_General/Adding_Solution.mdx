...
- Do not use variable names that could conflict with `using namespace std`. For example, don't
name a `std::set` "set."
- Avoid variable-length arrays as described [here](/bronze/intro-ds?lang=cpp#dynamic-arrays).
