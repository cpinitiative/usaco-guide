...
- Add comments throughout your code to explain your logic. Feel free to
  ...
  descriptive variable names and helpful comments.
...
- Use universally understandable variable names, especially for Bronze and
  ...
  in-contest.
- If you use a I/O template, collapse it with
  [`CodeSnip`](https://usaco.guide/general/working-mdx#code-blocks-and-code-snippets)s.
...
- Do not use variable-length arrays as discussed
  [here](/bronze/intro-ds?lang=cpp#dynamic-arrays).
- Do not include `cout.tie(0)` in your code; it does nothing (as discussed
  [here](/general/fast-io?lang=cpp#method-2---cintie0)).
- The C/C++ extension for
  ...
  You don't have to use a formatter, but doing so will ensure consistency.

#### Template/Macro Guidelines

For Bronze through Gold, avoid using additional macros (especially loop macros)
beyond the ones listed below (see
