...
## Note - Before Posting on the [Forum](https://forum.usaco.guide/)
...
- If you haven't found a small test case on which your program fails, try generating some (as described above).