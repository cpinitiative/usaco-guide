...
{/_ - Related - shifting an integer by $\ge 32$ bits? _/}
...
- Try everything above first.
  - If you've found a small counter-test, you should be able to figure out why
    your code isn't working on your own via print statements.
- Provide a link to the problem (and the relevant module, if applicable).
- Include what you've attempted so far.
- If you have code, post it (formatted as described
  [here](https://forum.usaco.guide/t/welcome-to-the-usaco-forum/7/2)).
  - Add comments.
