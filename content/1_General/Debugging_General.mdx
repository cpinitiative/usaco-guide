...
- Any undefined behavior? Can result in different outputs locally vs online.
  ...
  - Array out of bounds
    - C++ - considering using `::at` as mentioned
...
- If you have a small test case on which your solution fails as well as the
  ...
  correct), you are expected to figure out why your solution isn't working on
  your own.
  - Try simulating your solution by hand and see what output you come up with.
  - If you're not sure why your solution is producing a particular output, add
    print statements or use a [debugger](/general/debugging-lang/#debuggers)
    (though print statements alone almost always suffice).
