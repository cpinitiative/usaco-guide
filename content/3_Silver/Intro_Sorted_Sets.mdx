...
Although sorted sets might sometimes helpful for some USACO Silver, they are rarely required. Only one practice problem from this module is from USACO Silver.
