...
heapq.heapify(
	pq
)  # This line is not necessary since pq starts as an empty list. However, for lists of length greater than 1, heapify is required to turn the list into a heap.
