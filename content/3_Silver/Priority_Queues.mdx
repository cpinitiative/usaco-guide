...
[Sorted sets](/gold/intro-sorted-sets) support all the operations of priority queues and more; however, their constant factor is worse, and we don't have any examples of Silver problems that require the use of sorted sets.
