...
<Quiz>
  <Quiz.Question>
    ...
    <Quiz.Answer>
      A divide and conquer algorithm which splits an array into two halves to efficiently find an element satisfying a certain condition.
      <Quiz.Explanation>
        Incorrect.
      </Quiz.Explanation>
    </Quiz.Answer>
  ...
  <Quiz.Question>
    When would a solution be impossible when doing a collision two pointers algorithm (two pointers move from the ends of the array to the middle). 
    <Quiz.Answer>
