...
Now, we can move the right pointer to the end. This makes the sum of values $4$, since $1$ (previous cur val) $+2+1=4$, and has a length of 3. So, the maximum is now $3$.
<center>
<table>
	<tbody>
		<tr>
