...
The **Two Pointers** method iterates two pointers across an array to track indices satisfying some condition. There are two common ways to use two pointers:
