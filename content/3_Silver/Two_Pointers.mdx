...
<Quiz>
  <Quiz.Question>
    What's the two pointers algorithm?
    <Quiz.Answer correct>
      Keeping track of two pointers to find a pair of indices which satisfy some condition.
      <Quiz.Explanation>
        Correct.
    ...
    <Quiz.Answer>
      ...
      <Quiz.Explanation>
        Incorrect. You might be thinking of [Prefix Sums](https://usaco.guide/silver/prefix-sums), another silver topic.
      </Quiz.Explanation>
    </Quiz.Answer>
    <Quiz.Answer>
      An algorithm which splits an array into two halves to efficiently find an element satisfying a certain condition.
      <Quiz.Explanation>
        Incorrect.
      </Quiz.Explanation>
    </Quiz.Answer>
  ...
  <Quiz.Question>
    When would a solution not be possible?
    <Quiz.Answer>
      If the array isn't sorted.
      <Quiz.Explanation>
        Incorrect. There are certain two-pointers problems that do not require sorting the array. 
      </Quiz.Explanation>
    </Quiz.Answer>
    <Quiz.Answer correct>
      If the pointers overlap.
      <Quiz.Explanation>
        Correct. When the pointers overlap, they're looking for another solution to test when it doesn't exist.
      </Quiz.Explanation>
    </Quiz.Answer>
    <Quiz.Answer>
      If the pointers go out of the bounds of the array.
      <Quiz.Explanation>
        Incorrect.
      </Quiz.Explanation>
    </Quiz.Answer>
  ...
  <Quiz.Question>
    ...
    <Quiz.Answer>
      The time complexity of a standard two pointers algorithm is $\mathcal{O}(N)$
      <Quiz.Explanation>
    ...
    <Quiz.Answer>
      The space complexity of a standard two pointers algorithm is $\mathcal{O}(1)$
      <Quiz.Explanation>
    ...
    <Quiz.Answer correct>
      ...
      <Quiz.Explanation>
        Correct. The array doesn't necessarily have to be sorted.
      </Quiz.Explanation>
    </Quiz.Answer>
  </Quiz.Question>
</Quiz>
