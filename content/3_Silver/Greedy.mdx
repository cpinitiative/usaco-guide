...
export const problems = {
    ...
    cses: [
      new Problem("CSES", "Stick Lengths", "1074", "Easy", false, [], "Spoiler: Optimal length is median"),
...
<Resources>
  ...
  <Resource source="CPH" title="6 - Greedy Algorithms" starred>Scheduling, Tasks & Deadlines, Huffman Coding</Resource>
  <Resource source="PAPS" title="8 - Greedy Algorithms">DAGs, Scheduling</Resource>
  <Resource source="CPC" title="5 - Greedy Algorithms" url="05_greedy_algorithms">slides from Intro to Algorithms</Resource>
</Resources>
