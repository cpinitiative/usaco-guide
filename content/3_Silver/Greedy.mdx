...
export const problems = {
	studyalgo: new Problem('CF', 'Studying Algorithms', 'https://codeforces.com/gym/102951/problem/B', 'Very Easy', false, [], ''),
	movie: [new Problem('CSES', 'Movie Festival', '1629', 'Easy', false, [], '')],
	cses: [
		new Problem(
			'CSES',
			'Stick Lengths',
		...
		new Problem('CSES', 'Towers', '1073', 'Easy', true, ['multiset', 'greedy'], 'cses-1073'),
		new Problem(
			'CSES',
			'Tasks & Deadlines',
			'1630',
	...
	other: [
		...
		new Problem('Gold', 'High Card Low Card', '573', 'Normal', true, [], ''),
		new Problem('Silver', 'Berry Picking', '990', 'Normal', false, [], 'usaco-990'),
		new Problem(
			'Silver',
...
<FocusProblem problem={problems.movie[0]} />
