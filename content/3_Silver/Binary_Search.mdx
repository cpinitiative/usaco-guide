...
public class BinarySearch {
	public static void main(String[] args) {
		System.out.println(lastTrue(2,10,1)); // 10
		// all numbers satisfy the condition
		System.out.println(lastTrue(2,10,3)); // 5
		System.out.println(lastTrue(2,10,2)); // 1
		// no numbers satisfy the condition
	}

	public static boolean f1(int x){return true;}

	public static boolean f2(int x){return false;}

	public static int f3(int x){return x*x;}

	public static int lastTrue(int lo, int hi, int f) {
		for (--lo; lo < hi; ) {
			int mid = lo+(hi-lo+1)/2;
			// find the middle of the current range (rounding up)
			if(f == 1){
