...
<Quiz>
  <Quiz.Question>
    What is the worst and the best case time complexity for binary searching for a number in a sorted array of size $n$ with the following code, assuming that the inputted array is sorted?
