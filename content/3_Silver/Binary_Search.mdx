...
Following this idea, to increase the median to $x$, we need to increase the value of $array[i]$ (for $i$ starting from $\frac{n + 1}{2}$ (the position of the median) down to $n$), if it is less than the value $x$.
