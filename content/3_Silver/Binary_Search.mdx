...
Following this idea, to increase the median to a value x, we will need to increase the value of $array[i]$ (for i starting from  $(n + 1) / 2$ (the  position of the median) down to $n$), if it is less than the value x.
