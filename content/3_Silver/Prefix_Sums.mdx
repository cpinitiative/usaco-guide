...
{/_ equivalent to
[CSES Range Sum Queries I](https://cses.fi/problemset/task/1646) _/}
...
{/_ extremely dumb formatting should be fixed by better mdx parser in mdx 2.0
_/}
...
Check [Intro to Bitwise Operators](/gold/intro-bitwise) if you're not familiar
with XOR.
...
Hint: The XOR of any number with itself is zero.
