...
<!-- resources include templates/explanations/similar -->
<Resources>
...
<div className="mx-auto mt-2 overflow-hidden rounded-lg shadow-sm">
  {/* Header */}
  <div className="border-b border-gray-200 bg-purple-50 px-4 py-3 text-left text-sm font-medium text-purple-500 uppercase sm:px-6 dark:border-transparent dark:bg-purple-700/25 dark:text-purple-200">
    video guide
  </div>

  {/* Video Body */}
  <div className="p-6 bg-white dark:bg-gray-900">
    <YouTube id="f0bfiuDjq9A" />
  </div>
</div>

## Introduction
<!-- put brief intro text/overview-->
Prefix sums are a technique used to precompute the cumulative sums of an array to quickly find the sum of any subarray. Using $\mathcal{O}(N)$ precomputation time, subsequent queries can be found in $\mathcal{O}(1)$ time. This technique can also be generalized to invertible operations, such as [bitwise xor](https://usaco.guide/silver/intro-bitwise#xor-operation) or multiplication.
