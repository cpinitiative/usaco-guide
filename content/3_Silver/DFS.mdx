...
DFS is very useful when doing graph problems. Most silver problems involving graphs can be solved using DFS. This is why we recommended committing the strategies presented below to heart. 
