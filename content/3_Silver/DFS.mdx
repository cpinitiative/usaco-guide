...
## Quiz
Other questions concerning DFS and trees can be found in the [https://usaco.guide/silver/intro-tree](Introduction to Tree Algorithms) section.
...
<Quiz>
	<Quiz.Question>
		...
		<Quiz.Answer correct>
			No
			<Quiz.Explanation>
				Correct! Worst case, a DFS shortest path algorithm would have to iterate through <i>every</i> path before finding the shortest. Working shortest path algorithms will be covered later in the [https://usaco.guide/gold/shortest-paths](Gold section).
			</Quiz.Explanation>
		</Quiz.Answer>
	</Quiz.Question>
