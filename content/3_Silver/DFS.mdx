...
Some problems that can be solved with DFS may be more easily solved by [BFS](/gold/bfs)! A problem like [Comfy Cows](http://www.usaco.org/index.php?page=viewproblem2&cpid=1110) can be easily simulated with a `Queue`!
