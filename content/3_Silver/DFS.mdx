...
export const problems = {
    sample: [
      new Problem("CSES", "Building Roads", "1666", "Intro|Easy", false, ["DFS"], "@B"),
    ],
    general: [
      new Problem("CF", "Bear & Friendship", "contest/771/problem/A", "Easy", false, ["DFS"]),
      ...
      new Problem("CF", "PolandBall & Forest", "contest/problem/755/C", "Easy", false, ["Tree", "DFS"]),
...
<Resources>
  <Resource source="CSA" title="Depth First Search" url="depth_first_search" starred>code + interactive, don't worry about back edges</Resource>
  <Resource source="CPH" title="12.1 - DFS">code + example</Resource>
  <Resource source="IUSACO" title="10.4 - Depth First Search">code + example</Resource>
  <Resource source="PAPS" title="12.2 - Depth-First Search">pseudocode + example + code</Resource>
</Resources>
...
Since this is always possible, you must add $C-1$ edges, where $C$ is the number of connected components in the graph.
