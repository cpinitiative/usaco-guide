...
DFS is useful when working with Graph problems. Most Silver problems involving graphs can be solved using DFS. This is why it is recommended to commit the strategies presented below to heart. 
