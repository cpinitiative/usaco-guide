...
<Resources>
	...
	<Resource source = "YouTube" title = "DFS" url = "https://www.youtube.com/watch?v=-aDJhOAwI1I&list=PLtLxhThTxJMVMvWJoE2p8Z84tA8suGzvn&index=6">
		A video explaining the intuition behind DFS as well as the iterative and recursive implementation of DFS.
	</Resource>
</Resources>
...
There are many valid ways to pick $C-1$ new roads to build. The code below picks a single representative from each of the $C$ components and links them together in a line.
