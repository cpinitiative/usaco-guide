...
Some problems that can be solved with DFS, such as [Comfortable Cows](http://www.usaco.org/index.php?page=viewproblem2&cpid=1110), may be more easily solved with a queue (described in the [BFS](/silver/bfs) module).
