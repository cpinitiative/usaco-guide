...
<Resources>
	<Resource
		source="CF"
		title="EDU: Binary Search - Step 2"
		url="https://codeforces.com/edu/course/2/lesson/6/2/practice"
		starred
	></Resource>
...
int main() {
	cout << lstTrue(['Binary Search'](int x) { return true; },2,10) << "\n"; // 10
	// all numbers satisfy the condition
	cout << lstTrue(['Binary Search'](int x) { return x*x <= 30; },2,10) << "\n"; // 5
	cout << lstTrue(['Binary Search'](int x) { return false; },2,10) << "\n"; // 1
...
public class test{
	...
	public static void main(String['Binary Search'] args) throws IOException
	{
...
int main() {
	cout << fstTrue(['Binary Search'](int x) { return true; },2,10) << "\n"; // 2
	cout << fstTrue(['Binary Search'](int x) { return x*x >= 30; },2,10) << "\n"; // 6
	cout << fstTrue(['Binary Search'](int x) { return false; },2,10) << "\n"; // 11
}
```
...
static int n;
static long k;
static long['Binary Search'] arr;
public static void main(String['Binary Search'] args) {
...
```cpp
int main() {
	cout << fstTrue(['Binary Search'](int x) { return false; },-10,-10) << "\n"; // -8, should be -9
	cout << fstTrue(['Binary Search'](int x) { return true; },-10,-10) << "\n"; // infinite loop
}
```
