...
Kadane's Algorithm finds the largest subarray sum using a greedy method. Check the video below for details

[Video Solution to Max Subarray Sum](https://www.youtube.com/watch?v=jnoVtCKECmQ&t=611s).
