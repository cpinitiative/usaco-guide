...
export const problems = {
	...
	general: [
		...
		new Problem('Silver', 'Rental Service', '787', 'Normal', true, [], 'usaco-787'),
		new Problem('Silver', 'Mountain View', '896', 'Normal', true, [], ''),
		new Problem('Silver', 'Stuck in a Rut', '1064', 'Normal', false, ['Sorting'], 'usaco-1064'),
...
Sorting is a very general idea, so many of the problems below may use other Silver concepts, such as [prefix sums](/silver/prefix-sums).
