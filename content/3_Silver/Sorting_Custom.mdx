...
Sorting is a very general idea, so many of the problems below may use other Silver concepts, such as [prefix sums](/silver/prefix-sums), or [binary search](/silver/binary-search-ans), etc.
