...
//EndCodeSnip
	...
	indices.erase(unique(indices.begin(), indices.end()), indices.end());
		...
		"unique" also returns an iterator to the last element of the list (which has shifted left) after elements are deleted,
