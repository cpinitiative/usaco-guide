...
<Quiz>
  ...
  <Quiz.Question>
    ...
    <Quiz.Answer correct>
      ...
      <Quiz.Explanation>
        You would need to create an array of length $M$, and since $M$ can be up to $10^9$, that is too large. Instead, you can compress the $N$ unique values to be within the range of $N$. For example, $[1, 4, 10^9]$ becomes $[0, 1, 2]$, and therefore your array will only be a size of $N$.
      </Quiz.Explanation>
    </Quiz.Answer>
    <Quiz.Answer>
