...
<Quiz>
  <Quiz.Question>
    In the context of flood fill algorithms for grids, what does the "visited" array primarily track?
    <Quiz.Answer>
      The number of cells in the grid.
      <Quiz.Explanation>
        Incorrect. The "visited" array is not used to count cells but rather to track which cells have already been visited to avoid re-processing.
      </Quiz.Explanation>
    </Quiz.Answer>
    <Quiz.Answer correct>
      The cells that have been processed to avoid re-processing.
      <Quiz.Explanation>
        Correct! The "visited" array tracks cells that have been processed to prevent revisiting them during the flood fill algorithm.
      </Quiz.Explanation>
    </Quiz.Answer>
    <Quiz.Answer>
      The adjacent cells for each node.
      <Quiz.Explanation>
        Incorrect. The "visited" array is not concerned with adjacent cells specifically but with tracking the processing status of each cell.
      </Quiz.Explanation>
    </Quiz.Answer>
  </Quiz.Question>
  <Quiz.Question>
    How does flood fill differ from depth-first search (DFS) in terms of its application in grid-based problems?
    <Quiz.Answer correct>
      Flood fill explores all nodes uniformly, while DFS may prioritize certain paths.
      <Quiz.Explanation>
        Correct! Flood fill ensures uniform exploration of connected nodes, while DFS may explore paths based on the order of traversal chosen.
      </Quiz.Explanation>
    </Quiz.Answer>
    <Quiz.Answer>
      Flood fill does not require a stack for backtracking.
      <Quiz.Explanation>
        Incorrect. Flood fill, like DFS, typically uses a stack (or recursion) for backtracking to explore adjacent nodes.
      </Quiz.Explanation>
    </Quiz.Answer>
    <Quiz.Answer>
      Flood fill only visits cells with the same value.
      <Quiz.Explanation>
        Incorrect. Flood fill explores all connected cells regardless of their values, aiming to label connected components.
      </Quiz.Explanation>
    </Quiz.Answer>
  </Quiz.Question>
  <Quiz.Question>
    What is the primary advantage of using a non-recursive implementation of flood fill over a recursive one?
    <Quiz.Answer>
      Non-recursive implementations are faster on large grids.
      <Quiz.Explanation>
        Incorrect. The performance advantage of non-recursive implementations can vary and isn't universally faster on all grids.
      </Quiz.Explanation>
    </Quiz.Answer>
    <Quiz.Answer>
      Non-recursive implementations handle edge cases better.
      <Quiz.Explanation>
        Incorrect. Handling edge cases isn't typically a primary advantage of non-recursive implementations over recursive ones.
      </Quiz.Explanation>
    </Quiz.Answer>
    <Quiz.Answer correct>
      Non-recursive implementations use less memory.
      <Quiz.Explanation>
        Correct! Non-recursive implementations typically use iteration with stacks or queues, consuming less memory compared to recursive implementations.
      </Quiz.Explanation>
    </Quiz.Answer>
  </Quiz.Question>
</Quiz>
