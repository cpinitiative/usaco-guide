...
<Quiz>
	...
	<Quiz.Question>
		Which of the following is **not** information we could get from the results of some number of iterations of a standard floodfill algorithm `void ff(int x, int y)`?
		<Quiz.Answer>
			The number of connected components of a graph
			<Quiz.Explanation>
				Incorrect. We find the number of connected components by tracking the number of initial calls.
			</Quiz.Explanation>
		</Quiz.Answer> 
		<Quiz.Answer>
		...
		<Quiz.Answer correct>
			...
			<Quiz.Explanation>
				Correct! This cannot be found with standard floodfill, because it doesn't keep track of distances.
			</Quiz.Explanation>
		</Quiz.Answer>
		<Quiz.Answer>
