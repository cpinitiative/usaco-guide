...
In some problems if you make your grid exactly N x M your code will output the wrong answer even though the rest of your algorithm is correct. This is because some areas that can be flooded can be blocked if there is an unvisitable element right at the edge of your matrix. The solution is to create your grid at least one row and one column larger and offsetting your points based on how you increased the size of the matrix.    	
...
A non-recursive implementation of flood fill follows:
