...
Recursive implementations of flood fill can sometimes lead to a stack overflow (also see [adjusting stack sizes](/general/cpp-command#adjusting-stack-size)).
