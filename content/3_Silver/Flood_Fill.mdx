...
above, below, and to the left and right of our current square. Due to it's
recursive nature, you can think of floodfill as a modified version of
...
A non-recursive implementation of flood fill adds the edges to a stack or queue, similar to [BFS](https://usaco.guide/gold/bfs), and is usually implemented as follows:
