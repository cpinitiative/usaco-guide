...
A non-recursive implementation of flood fill adds the edgesto a stack or queue, similar to [BFS](https://usaco.guide/gold/bfs), and is usually implemented as follows:
