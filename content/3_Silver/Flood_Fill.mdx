...
prerequisites:
  - dfs
description: 'Finding connected components in a graph respresented by a grid.'
frequency: 3
---
...
export const problems = {
	...
	general: [
		new Problem('Silver', 'Ice Perimeter', '895', 'Easy', true, []),
		new Problem(
			'Silver',
		...
		new Problem('Silver', "Where's Bessie?", '740', 'Normal', true, []),
		new Problem(
			'Silver',
			'Why Did ... (Count Cross)',
			'716',
...
<Warning>
Recursive implementations of floodfill in Java can sometimes lead to StackOverflowError. The solution to this is using your own stack in an iterative implementation like the one below.
</Warning>
