...
<Resources>
	...
	<Resource source="CF" title="EDU: Binary Search" url="https://codeforces.com/edu/course/2/lesson/6" starred>
		video explanation of binary search
	</Resource>
	<Resource source="CF" title="EDU: Binary Search - Step 1" url="https://codeforces.com/edu/course/2/lesson/6/1/practice" starred> 
		problems similar to those covered in this module
	</Resource>
	<Resource
