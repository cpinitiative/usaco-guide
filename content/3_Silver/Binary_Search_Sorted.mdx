...
As each of the points are in the range $0 \ldots 1,000,000,000$, storing locations of haybales in, for instance, a boolean array, would take too much memory.
...
The [official solution](http://www.usaco.org/current/data/sol_haybales_silver_dec16.html) does not use a library implementation of binary search.
