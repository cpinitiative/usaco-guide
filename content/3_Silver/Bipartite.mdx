...
export const problems = {
  bipsample: [
    new Problem("CSES", "Building Teams", "1668", "Easy", false, ["Bipartite"], "@B"),
  ],    
  bip: [
    ...
    new Problem("CF", "Baltic OI - Graph", "contest/1387/problem/A", "Hard", false, [], ""),
...
<Resources>
  <Resource source="CPH" title="12.3 - Bipartiteness check" starred>Brief solution sketch with diagrams.</Resource>
  <Resource source="IUSACO" title="10.7 - Bipartite Graphs">Uses BFS, but DFS accomplishes the same task.</Resource>
