...
export const problems = {
	...
	cses: [
		...
		new Problem(
			...
			'Easy',
			true,
			['Ordered Set', 'Greedy', 'LIS', 'Binary Search'],
			'cses-1073'
		),
		new Problem(
			'CSES',
...
<Resources>
	...
	<Resource source = "YouTube" title = "Greedy Algorithms" url = "https://www.youtube.com/watch?v=vOYDh_st-K8&list=PLtLxhThTxJMVMvWJoE2p8Z84tA8suGzvn&index=15">
		A video demonstrating classic greedy problems such as the scheduling problem. He codes the solutions to some of the problems in Python, while mostly explaining the intuition and problem-solving strategy behind the solution.
	</Resource>
</Resources>
...
<FocusProblem problem={problems.studyalgo} />
...
<FocusProblem problem={problems.movie} />
