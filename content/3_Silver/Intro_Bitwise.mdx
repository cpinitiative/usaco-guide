...
<Quiz>
  ...
  <Quiz.Question>
    Which function gets the total number of bits set to true in an integer x?
    <Quiz.Answer>
      __builtin_clz(x)
      <Quiz.Explanation>
        Incorrect. This gives the number of zeros at the beginning of the number.
      </Quiz.Explanation>
    </Quiz.Answer>
    <Quiz.Answer>
      __builtin_ctz(x)
      <Quiz.Explanation>
        Incorrect. This gives the number of zeros at the end of the number.
      </Quiz.Explanation>
    </Quiz.Answer>
    <Quiz.Answer correct>
      __builtin_popcount(x)
      <Quiz.Explanation>
        Correct. This gives the number of bits set to true in the number.
      </Quiz.Explanation>
    </Quiz.Answer>
    <Quiz.Answer>
      __builtin_parity(x)
      <Quiz.Explanation>
        Incorrect. This gives the parity (even or odd) of the bits set to true in the number.
      </Quiz.Explanation>
    </Quiz.Answer>
  </Quiz.Question>
  <Quiz.Question>
