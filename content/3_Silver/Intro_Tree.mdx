...
export const problems = {
	...
	tree: [
		...
		new Problem('Silver', 'Milk Visits', '968', 'Easy', false, ['DFS']),
		new Problem(
			'IOI',
			'2010 - Traffic',
		...
		new Problem(
			...
			false,
			['Tree', 'DFS'],
			'@CPH 14.2' // intentionally not 14.3 -- use 14.2 Algorithm 2 instead
		),
		...
		new Problem('Silver', 'Clock Tree', '1016', 'Normal', false, ['Tree', 'Bipartite']),
		new Problem(
			'CF',
			"Wizard's Tour",
			'860/problem/D',
...
<Resource source="SecondThread" title="Tree Basics - Tree Diameter" url="https://codeforces.com/blog/entry/81527"> </Resource>
</Resources>
