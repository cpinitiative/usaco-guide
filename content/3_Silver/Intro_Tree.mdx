...
{/_ Typically, after arbitrarily rooting a tree, some interesting pieces of
information are a node's parent, subtree size, and depth. _/}
...
The following sample code computes the **parent**, **depth**, and **subtree
sizes** of each node of a tree, assuming node 1 is the root.
