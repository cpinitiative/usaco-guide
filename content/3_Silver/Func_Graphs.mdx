...
int main()
{
	...
	// For each node, we have to use a vector to store its children since at nodes 
	// combining the cycle with other parts of the connected component,
...
public class Badge {
	...
	/*
	 * For each node, we need a list to store its children since at nodes
