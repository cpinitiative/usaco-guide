...
The strategy of graph traversal is to visit all nodes within a graph and compute some information along the way. Two common algorithms for doing this are **DFS** and **BFS**.

In a depth-first search, we travel as far down a branch as we can before backtracking.

![](/resources/dfs_demo.gif)

In a breadth-first search, we travel through the vertices in order of their distance from the starting vertex.

![](/resources/bfs_demo.gif)
...
public static void main(String[] args) throws IOException {
	...
	/*
	 * Read in problem-specific input
	 */
