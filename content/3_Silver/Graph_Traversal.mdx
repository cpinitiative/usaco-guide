...
See `collections.deque()` in the next section;
using only `.appendleft` and `.pop`, we effectively have a queue.
...
Traceback (most recent call last):
  File "input/code.py", line 25, in <module>
    count_components()
  File "input/code.py", line 23, in count_components
    dfs(i)
...
Note: This passes when submitted in CPython3,
but TLEs on two testcases when submitted in PyPy3.
