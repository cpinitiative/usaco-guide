...
is limited to a few megabytes by default. To address this, refer to the module on
[increasing stack size](/general/cpp-command#adjusting-stack-size-mac).
Short answer: If you would normally compile your code as `g++ sol.cpp`,
compile it with `g++ -Wl,-stack_size,0xF0000000 sol.cpp` instead.
