...
{/* Hard, would recommend skipping (1700 on CF) */} {/* Hard, do not attempt
until Gold/Plat (2100 on CF) */} {/* First solve problem for $n$-th tournament
only. Extremely hard, do not attempt (2700 on CF) */}
