...
export const problems = {
	...
	e2: [new Problem('Plat', 'Valleys', '950', 'Very Hard', false, [], '')],
	other: [
		new Problem(
			'Kattis',
			'Island Archipelago',
		...
		new Problem(
			'CF',
			'Rectangles & Connected Regions',
			'https://codeforces.com/gym/100453',
			'Very Hard',
			false,
			["Euler's Formula"],
			''
		),
		new Problem('Plat', 'Paint by Letters', '1094', 'Very Hard', false, ["Euler's Formula"], ''),
	],
};
