...
A simpler version of the persistent segment tree is the persistent array, where
one only does **point** updates and queries.
...
we use **path copying** instead. You will be introduced to this technique below.
