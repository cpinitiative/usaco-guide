...
The **Suffix Tree** is a trie that contains all suffixes of a string. Naively, this would take up $O(N^2)$ memory, but _path compression_ enables it to be represented and computed in linear memory.
