...
export const problems = {
	...
	general_suffix: [
		new Problem(
			'CF',
			'Suffix Array',
			'edu/course/2/lesson/2/2/practice/contest/269103/problem/A',
			'Easy',
			true,
			['Suffix Structures'],
			'Try building suffix tree/automaton and converting!'
		),
		new Problem(
			'Kattis',
			...
			false,
			[],
			'Try solving it using Suffix Tree or Suffix Automaton!'
		),
		new Problem(
			'onlinejudge.org',
			'I Love Strings!!',
		...
		new Problem('CF', 'Mike & Friends', '547/problem/E', 'Easy', false, [], ''),
		new Problem(
			'HE@HackerEarth',
			'Power of String 3',
...
The **Suffix Tree** is a trie that contains all suffixes of a string. Naively, this would take up $\mathcal{O}(N^2)$ memory, but _path compression_ enables it to be represented and computed in linear memory.
...
<Problems problems={problems.general_suffix} />
...
<Problems problems={problems.paltree} />
