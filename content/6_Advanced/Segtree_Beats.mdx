...
Consider an extention to this problem such that operation 3 could be range set updates instead of point set. 
...
Although strictly speaking, **The Child and Sequence** is not a segment tree beats problem, the techniques used in it are closely related. 
