...
{/_ - Also consider the older `#pragma GCC target ("sse4")`. _/}
...
{/_ - [`unroll-loops`](https://codeforces.com/contest/855/submission/89815160):
TLE 49 _/} {/_ -
[`Ofast`, `unroll-loops`](https://codeforces.com/contest/855/submission/89815262):
3509ms _/}
...
{/_ Anyways, keep in mind that these rarely make a difference in competitive
programming. _/}

{/_ <IncompleteSection /> _/}
