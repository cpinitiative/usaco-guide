...
Let the values of $a_1,a_2,\dots,a_N$ after all the transfers be
$a_1',a_2',\dots,a_N'$. If we know this final sequence, how much did the
...
$(d_0',d_1',\dots,d_N')$ that satisfies this property corresponds to a valid
...
to determine $d_0',d_1',\dots,d_i'$ such that $d_i'\le j$. Note that by
