...
It is possible to reduce this to $O(N^{2/3})$ time (see [this comment](https://codeforces.com/blog/entry/117635?#comment-1041002)).
...
Note: You can optimize this to $O(N^{2/3})$ by applying the method introduced
