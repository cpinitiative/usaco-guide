...
Recall the old O(n Log(n)) sieve in [our old guide on divisibility](https://usaco.guide/gold/divisibility?lang=cpp#solution---counting-divisors), let's improve upon that real quick. Below is the implementation of linear sieve, which will be used in both focus problem 1 and 3:
For further information, check [this CF blog entry](https://codeforces.com/blog/entry/54090).
