...
export const problems = {
	sample: [
		new Problem('Gold', 'Springboards', '995', 'Hard', false, ['PURQ'], ''),
	],
	problems: [
		new Problem('Plat', 'Nocross', '721', 'Hard', false, ['PURQ'], ''),
		new Problem(
			'CF',
			'Rainbow Rectangles',
			'1396/problem/D',
...
<!-- new Problem('CSES', 'Projects', '1140', 'Easy', false, [], 'https://codeforces.com/blog/entry/70018'), -->
...
You can check the [analysis](http://www.usaco.org/current/data/sol_boards_gold_jan20.html) for the full solution to the original problem.
