...
To find the maximum flow we'll handle a **preflox** which satisfies all the constraints of the flow, but not necessarile the conservation law. It means that the incoming flow can exceed the outgoing flow. 
