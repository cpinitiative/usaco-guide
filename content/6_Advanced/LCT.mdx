...
An alternative solution is to use the Euler Tour Tree (ETT) technique, which builds upon the <a href="https://usaco.guide/gold/tree-euler/">Euler Tour Technique</a> by storing the Euler Tour of the tree in a balanced binary search tree instead of an array.
