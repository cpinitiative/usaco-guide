...
export const problems = {
    ...
    path: [
      ...
      new Problem("CF", "Baltic OI - Joker", "contest/1386/problem/C", "Hard", false, ["LCT"], ""),
      ...
      new Problem("ojuz", "IOI - Dancing Elephants", "IOI11_elephants", "Hard", false, [], "https://github.com/mostafa-saad/MyCompetitiveProgramming/blob/master/Olympiad/IOI/official/2011/elephants.pdf"),
    ],
    subSam: [
    ...
    sub: [
      ...
      new Problem("CF", "Old Driver Tree", "contest/1172/problem/E", "Very Hard", false, ["LCT"], ""),
