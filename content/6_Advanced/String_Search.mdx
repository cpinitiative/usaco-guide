...
**Manacher's Algorithm** is functionally similar to the **Z-Algorithm** and can compute information about palindromes. It can determine the longest palindrome centered at each character.
