...
The suffix links for the root and all its immediate children point to the root node. For all other nodes $u$ with parent $p$ and letter $c$ on the edge $p\rightarrowu$ the suffix link 
