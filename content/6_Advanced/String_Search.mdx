...
<Resources>
	<Resource
	 ...
	 />
	<Resource source="PAPS1" title="19.2 - String Matching" />
	<Resource
		source="GFG"
		title="KMP Algorithm"
...
To efficiently compute this array, we maintain the $[l, r]$ interval such that $S_{l\dots r}$ is also a prefix, i.e. $Z_l=r-l+1$.
...
<Resources>
	...
	<Resource source="PAPS1" title="19.1 - Tries" />
</Resources>
