...
export const problems = {
	...
	trie: [
		new Problem(
			...
			false,
			['Strings', 'DFS', 'Trie'],
			'https://hsin.hr/coci/contest3_solutions.zip'
			// TODO: Change solution link next year because the link changes
		),
		new Problem(
			'IOI',
			'2008 - Type Printer',
		...
		new Problem(
			'COCI',
			'2020 - Klasika',
			'https://oj.uz/problem/view/COCI20_klasika',
			'Normal',
			false,
			['Trie'],
		...
		new Problem(
			'IZhO',
			'2012 - XOR',
			'https://oj.uz/problem/view/IZhO12_xor',
			'Hard',
			false,
			['Trie', 'Greedy'],
			''
