...
To efficiently compute the z-array, we maintain the $[l, r]$ interval such that S_{l...r} is also a prefix, i.e. $Z_l=r-l+1$. Let's denote $i \n [l, r]$ an arbitrary position, this gives us the following cases:
