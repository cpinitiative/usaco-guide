...
z-algorithm doesn't use $\pi$ function, instead it uses the **z-function** defined as: $Z_i$ = the length of the longest string that is both the prefix of string $S$ and $S_{i...n}$ - the substring
starting from $i$ to its end.
