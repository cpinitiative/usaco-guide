...
description: Decomposing the Kruskal's algorithm to solve problems about maximum/minimum edge weights
---
...
Note that maintaining the relationships of components can be done in amortized logarithmic complexity using path compression similar to a [DSU](https://usaco.guide/gold/dsu?lang=cpp).
