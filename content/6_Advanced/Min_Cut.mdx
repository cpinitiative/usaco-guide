...
export const problems = {
	...
	cut: [
		new Problem('CSES', 'Police Chase', '1695', 'Easy', false, [], 'cses-1695'),
		new Problem(
			'Old Gold',
			'Cow Steeplechase',
			'93',
...
<FocusProblem problem={problems.pathEx[0]} />

<Resources>
	<Resource source="CPH" title="20.4 - Path Covers" starred>brief mentions of node-disjoint and general path covers, Dilworth's theorem</Resource>
	<Resource
		source="Wikipedia"
		title="Dilworth's Theorem"
		url="https://en.wikipedia.org/wiki/Dilworth%27s_theorem#Proof_via_K%C5%91nig's_theorem"
	>proof via Konig's theorem</Resource>
</Resources>
