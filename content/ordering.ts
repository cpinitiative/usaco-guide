...
const MODULE_ORDERING: { [key in SectionID]: Chapter[] } = {
  ...
  silver: [
    ...
    },
    {
      ...
      items: ['dfs', 'flood-fill', 'intro-tree', 'bfs', 'func-graphs'],
    },
    {
      name: 'Conclusion',
      description: 'Congratulations on making it this far!',
  ...
  gold: [
    ...
    },
    {
      ...
      description:
        'Most Silver to Platinum contests have at least one graph problem.',
      items: ['dsu', 'toposort', 'shortest-paths', 'mst'],
    },
    {
...
export const SECTION_SEO_DESCRIPTION: { [key in SectionID]: string } = {
  ...
  silver:
    'Topics for USACO Silver include binary search on the answer, prefix sums, two pointers, dfs/bfs, floodfill, trees, custom comparators, greedy with sorting, and more!',
