...
description: "Interesting properties of a functional graph, a directed graph in which every vertex has exactly one outgoing edge, (and how to easily detect cycles ? )."
frequency: 1
---
