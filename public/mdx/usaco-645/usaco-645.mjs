...
function _createMdxContent(props) {
  ...
  return _jsxDEV(_Fragment, {
    children: [_jsxDEV(_components.p, {
      ...
      children: ["Since the enclosures must be rectangular, there ", _jsxDEV(_components.em, {
        children: "must"
      }, undefined, false, {
        fileName: "<source.js>",
        lineNumber: 16,
        columnNumber: 49
      }, this), " be a vertical or horizontal line that separates the two. Otherwise,\r\nwe'd have a case where one enclosure would have to overlap the other in order to enclose all the cows."]
    }, undefined, true, {
      fileName: "<source.js>",
      lineNumber: 16,
      columnNumber: 1
      ...
      children: _jsxDEV(_components.img, {
        src: "/solutions/silver/usaco-645/enclosures.png",
        alt: ""
      }, undefined, false, {
        fileName: "<source.js>",
        lineNumber: 19,
      ...
      children: ["Thus, we'll perform two sweeps, one checking vertical splits, and the other checking horizontal splits. To keep track of the best answer, we'll keep\r\nprefix and suffix minimums and maximums to calculate each possible solution in ", _jsxDEV(_components.code, {
