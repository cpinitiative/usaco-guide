...
function _createMdxContent(props) {
  ...
  return _jsxDEV(_Fragment, {
    children: [_jsxDEV(_components.p, {
      ...
      children: "Let's represent each given pair as a 4-letter string (city prefix + state code) and use a map to track frequencies.\r\nFor each string we check if its mirror exists and increase our count accordingly."
    }, undefined, false, {
      fileName: "<source.js>",
      lineNumber: 6,
      columnNumber: 1
