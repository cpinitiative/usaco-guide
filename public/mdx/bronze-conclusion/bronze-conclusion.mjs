...
function _createMdxContent(props) {
  ...
  return _jsxDEV(_Fragment, {
    children: [_jsxDEV(_components.h2, {
      id: "user-content-what-now",
      children: [_jsxDEV(_components.a, {
        "aria-hidden": "true",
        tabIndex: "-1",
        className: "anchor before",
        href: "#user-content-what-now",
      ...
      children: ["After completing this section on the USACO Guide, you should be comfortable with\r\nthe topics that have historically appeared in the USACO Bronze\r\ndivision. In order to maximize your chance at promoting, you should\r\naim to ", _jsxDEV(_components.strong, {
        children: "practice"
      }, undefined, false, {
        fileName: "<source.js>",
        lineNumber: 9,
        columnNumber: 8
      }, this), " by doing more problems."]
    }, undefined, true, {
      fileName: "<source.js>",
      lineNumber: 4,
      columnNumber: 1
      ...
      children: "Below we list some problems that we think are roughly Bronze level but don't\r\nreally fit in previous modules. The difficulties listed here are relative to the Bronze\r\ndivision (difficulty is subjective and isn't always accurate though). We'll be\r\nexpanding this list as we get more problem suggestions."
    }, undefined, false, {
      fileName: "<source.js>",
      lineNumber: 13,
      columnNumber: 1
