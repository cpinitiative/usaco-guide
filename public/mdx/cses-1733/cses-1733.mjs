...
function _createMdxContent(props) {
  ...
  return _jsxDEV(_Fragment, {
    children: [_jsxDEV(_components.h2, {
      ...
      children: ["We can check if every prefix is valid using brute force. Due to harmonic series, this will only take ", _jsxDEV(_components.code, {
        ...
        lineNumber: 4,
        columnNumber: 102
      }, this), " time if we can compare a substring to a prefix in ", _jsxDEV(_components.code, {
        className: "language-math",
