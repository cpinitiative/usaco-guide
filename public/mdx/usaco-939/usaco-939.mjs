  ...
  return _jsxDEV(_Fragment, {
    children: [_jsxDEV(_components.p, {
      ...
      children: ["If there was no rock, then the number of cows needed would just be the\r\nhorizontal distance between the barn and the lake, plus the vertical distance\r\nbetween the barn and the lake, minus ", _jsxDEV(_components.code, {
        ...
        lineNumber: 17,
        columnNumber: 43
      }, this), " extra cows to go around the rock."]
    }, undefined, true, {
      fileName: "<source.js>",
      lineNumber: 12,
      columnNumber: 1
