  ...
  return _jsxDEV(_Fragment, {
    children: [_jsxDEV(_components.h2, {
      ...
      children: [_jsxDEV(_components.strong, {
        ...
        className: "language-math",
        children: "\\mathcal{O}(N \\log N + N^2 \\cdot \\max(R, C))"
      }, undefined, false, {
        fileName: "<source.js>",
        lineNumber: 12,
        columnNumber: 22
