  ...
  return _jsxDEV(_Fragment, {
    children: [_jsxDEV(_components.p, {
      children: _jsxDEV(_components.a, {
        href: "https://zibada.guru/gcj/ks2021a/problems/#analysis-D",
        rel: "nofollow",
        target: "_blank",
      ...
      children: ["\n", _jsxDEV(_components.li, {
        children: ["Firstly, note that the number of rows and columns is equivalent to ", _jsxDEV(_components.code, {
          ...
          lineNumber: 12,
          columnNumber: 14
        }, this), " to distinguish row ", _jsxDEV(_components.code, {
          className: "language-math",
          children: "i"
        }, undefined, false, {
          fileName: "<source.js>",
          lineNumber: 12,
          columnNumber: 37
        }, this), " from column ", _jsxDEV(_components.code, {
          className: "language-math",
          children: "j"
        }, undefined, false, {
          fileName: "<source.js>",
      ...
      children: ["\n", _jsxDEV(_components.p, {
        children: ["Of course, the problem of finding a minimum weight cycle breaking edge set is\r\nequivalent to the well known problem of finding a maximum weight spanning\r\nforest of ", _jsxDEV(_components.code, {
          ...
          lineNumber: 16,
          columnNumber: 13
        }, this), ", except that we would build the complement set of edges to keep\r\nrather than the set of edges to remove."]
      }, undefined, true, {
        fileName: "<source.js>",
        lineNumber: 14,
        columnNumber: 3
