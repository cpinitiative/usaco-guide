...
function _createMdxContent(props) {
  ...
  return _jsxDEV(_Fragment, {
    children: [_jsxDEV(_components.p, {
      ...
      children: ["With this observation, the solution is relatively simple. Check for this adjacency, and if it exists, print \"No.\" Otherwise, proceed by surrounding the bad people with walls. Floodfill from the end point ", _jsxDEV(_components.code, {
        className: "language-math",
        children: "(N - 1,\\space M - 1)"
      }, undefined, false, {
        fileName: "<source.js>",
        lineNumber: 17,
        columnNumber: 205
      }, this), ", and make sure that all the good people have been visited. You do not need to check if the bad people did not make it, as surrounding the bad people with walls is sufficient."]
    }, undefined, true, {
      fileName: "<source.js>",
      lineNumber: 17,
      columnNumber: 1
